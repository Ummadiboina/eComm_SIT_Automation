Feature: 25_Reg_Agent_GenerateCCA_Not_EndUser
  ...
  Scenario Outline: Successful completion of a PAY M Acquistion journey by CCA settlement
    ...
    Examples:
      | Device                        | Tariffs | Extras | BSCstatus | BillCapAmount | DeliveryType | Firstname | Surname | Username     | HouseNumber | PostCode | Password | confirmPassword | SecurityAnswer | B1  | B2  | B3  | B4  | Text | Email | Phone | Post | Consumer | GDPRstatus | GDPRstatus2 | username                     | password | MBBStatus | DeviceType | DeviceModule | PreSelected | KeyEvent |
      | Oneplus 6T 128GB Mirror Black | Refresh | Base   | Enabled   | £60           | HomeDelivery | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test123  | test123         | vinudeep       | Not | Not | Not | Not | Not  | Not   | Not   | Not  | Someone  | Enabled    | Disabled    | ink_jun8829@stf.ref.o2.co.uk | test123  | No        | Connected  | Phone        | Yes         | No       |
