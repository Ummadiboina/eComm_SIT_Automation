Feature: 25_Reg_Agent_GenerateCCA_Not_EndUser
  ...
  Scenario Outline: Successful completion of a PAY M Acquistion journey by CCA settlement
    ...
    Examples:
      ...
      | iPhone 7 Plus 32GB Rose Gold | Refresh | Base   | Enabled   | £60           | HomeDelivery | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test123  | test123         | vinudeep       | Not | Not | Not | Not | Not  | Not   | Not   | Not  | Someone  | Enabled    | Disabled    | ink_jun8829@stf.ref.o2.co.uk | test123  | No        | Connected  | Phone        | Yes         | No       |
