...
Feature: 12_CFA_NewConnection_PAYM_Phone_GDPR_Enabled_Refresh_CC_EndUser_MP_OptOut_All
  ...
  @Web
  Scenario Outline:12_CFA_NewConnection_PAYM_Phone_GDPR_Enabled_Refresh_CC_EndUser_MP_OptOut_All
    ...
    Examples:
      ...
      | iPhone X | Silver | TEST      | ACCEPTA | TEST ACCEPTA | Enabled    | Enabled   | CapMyBill | £30       | Not | Not | Not | Not | Connected  | No          | No       |
