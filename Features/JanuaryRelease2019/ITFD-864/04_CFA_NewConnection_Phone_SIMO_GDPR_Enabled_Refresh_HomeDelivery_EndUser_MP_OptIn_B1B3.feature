Feature: 04_CFA_NewConnection_Phone_SIMO_GDPR_Enabled_Refresh_HomeDelivery_EndUser_MP_OptIn_B1B3
  ...
  @Web
  Scenario Outline: 04_CFA_NewConnection_Phone_SIMO_GDPR_Enabled_Refresh_HomeDelivery_EndUser_MP_OptIn_B1B3
    ...
    Examples:
      ...
      | 12 Months | TEST      | ACCEPTA | TEST ACCEPTA | Enabled   | CapMyBill | £0        | Select | Not | Select | Not | Enabled    | Connected  | No          | No       |
