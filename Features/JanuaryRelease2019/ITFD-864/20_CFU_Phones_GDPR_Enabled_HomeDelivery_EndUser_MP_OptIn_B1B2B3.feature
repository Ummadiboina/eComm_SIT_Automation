Feature: 20_CFU_Phones_GDPR_Enabled_HomeDelivery_EndUser_MP_OptIn_B1B2B3
  ...
  @Web
  Scenario Outline: 20_CFU_Phones_GDPR_Enabled_HomeDelivery_EndUser_MP_OptIn_B1B2B3
