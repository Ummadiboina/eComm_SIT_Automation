Feature: 122_FR_Mix_CFU_Phone
  ...
  Scenario Outline: 10_1_FR_Mix_CFU_Phone
    ...
    Examples:
      ...
      | stester332bd891-dd8f-49f2-b245-01e17cbdb1e9@gmail.com | test123  | iPhone 7 | avg     | avg  | avg  | skip   | TEST      | ACCEPTA | TEST ACCEPTA | low        | Disabled  | Monthly data (High to low) | A3 10      | Me       | Select | Not | Not | Not | Not  | Select | Not   | Not  | Enabled    | No        | Connected  | min     | min  | min  | No          | No       |
