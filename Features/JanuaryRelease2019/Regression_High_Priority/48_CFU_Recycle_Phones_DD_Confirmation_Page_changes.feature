Feature: 48_CFU_Recycle_Phones_DD_Confirmation_Page_changes
  ...
  then the customer should be able to see the changes in 'Confirmation Page formatting box'
    ...
    Examples:
      ...
      | stester117bb1fde1-8d4a-4e95-a619-d2adffcd4e5f@gmail.com | test123  | Enabled   | CapMyBill | £5        | iPhone Xs Max | 29.99upfront60.34amonth | TEST      | ACCEPTA | TEST ACCEPTA | skip   | Delayed Delivery | Apple | Iphone7 | Orange  | Me       | Select | Not | Not | Not | Select | Not   | Not   | Not  | Enabled    | No        | Connected  | No          | No       |
