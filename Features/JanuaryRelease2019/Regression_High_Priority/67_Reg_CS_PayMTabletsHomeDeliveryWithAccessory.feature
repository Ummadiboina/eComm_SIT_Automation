Feature: 67_Reg_CS_PayMTabletsHomeDeliveryWithAccessory
  ...
  Scenario Outline: PayM Tablets Home delivery E2E journey with Accessory
    ...
    Examples:
      ...
      | iPad Pro 10.5 inch | Space Grey | 512GB    | Enabled   | DontCapMyBill | Nill      | TEST      | ACCEPTA | TEST ACCEPTA | Me       | Not | Select | Not | Not | Select | Select | Not   | Not  | Enabled    | No        | Connected  | No          | No       |
