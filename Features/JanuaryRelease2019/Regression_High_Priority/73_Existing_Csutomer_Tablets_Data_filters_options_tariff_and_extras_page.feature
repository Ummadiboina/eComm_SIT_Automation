Feature: 73_Existing_Csutomer_Tablets_Data_filters_options_tariff_and_extras_page
  ...
  Scenario Outline: Existing_Customer_Tablets_Data_filters_options_tariff_and_extras_page
    ...
    Examples:
      ...
      | A3 10      | Space Grey | 512GB    | low        | Enabled   | CapMyBill | £60       | Monthly data (Low to High) | prashanth.dosala@telefonica.com | test123  | TEST ACCEPTA | Me       | Not | Not | Select | Not | Not  | Select | Not   | Not  | Enabled    | No        | Connected  | No          | No       |
