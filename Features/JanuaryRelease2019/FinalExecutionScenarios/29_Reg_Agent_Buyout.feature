Feature: 29_Reg_Agent_Buyout
  ...
  Scenario Outline: Successful completion of a BuyOut Journey
    ...
    Examples:
      ...
      | 07521105408 | iPhone 6s Plus 32GB Rose Gold | Enabled   | £15           | Refresh | erto@1234.com | HomeDelivery | Test      | Accepta | Flat 9      | SL11EL   | Test Accepta | test123  | Me       | Not | Not | Select | Not | Select | Select | Select | Select | Enabled | No        | Connected  | No          |