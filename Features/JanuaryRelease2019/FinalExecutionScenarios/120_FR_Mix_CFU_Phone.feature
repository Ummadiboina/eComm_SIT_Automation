Feature: 120_FR_Mix_CFU_Phone
  ...
  Scenario Outline: 120_FR_Mix_CFU_Phone
    ...
    Examples:
      ...
      | in02818o_759850@o2.com | test123  | Test      | Accepta | Enabled   | TEST ACCEPTA | enterCode | Galaxy Note9 | Me       | Select | Not | Select | Not | Select | Not   | Not   | Not  | Enabled    | No        | Connected  | max     | max  | max  | Yes         | No       |
