Feature: 74_Reg_FNT_AFA_Handset_Click_and_Collect_Passport_and_Driving_license
  ...
  Scenario Outline: This test scenario ensures that a CC order is successful which accepts additional information like Passport details Driver License details and additional card details but is finally in Referred status
    ...
    Examples:
      | Device                                  | Tariffs | License_postcode | License_Number | BSCstatus | BillCapAmount | country | Passport_number | Firstname | Surname  | Username      | HouseNumber | PostCode | postCode | B1  | B2  | B3     | B4  | Text | Email | Phone | Post | Consumer | status  | Password | confirmPassword | SecurityAnswer | MBBStatus | DeviceType | DeviceModule |
      | Samsung Galaxy S9 Plus 128GB Coral Blue | Refresh | sl11el           | 122SS23ERT     | Enabled   | £0            | IND     | G02DSRE£        | TEST      | ADDINFOI | TEST ADDINFOI | 14          | SL11UP   | TQ13DG   | Not | Not | Select | Not | Not  | Not   | Not   | Post | Me       | Enabled | test123  | test123         | Jkhan          | No        | Connected  | Phone        |
