Feature: 76_Reg_FNT_DifferentStoreAddressthanBillingAddres
  ...
  Scenario Outline: FNT PayM Different store address than billing address
    ...
    Examples:
      | handset      | color          | Capacity | Firstname | BSCstatus | BillCap       | CapAmount | Surname | Username     | consumer | B1     | B2  | B3     | B4  | Text   | Email | Phone | Post   | status  | MBBStatus | DeviceType | PreSelected |
      | Galaxy Note9 | Midnight Black | 128GB    | TEST      | Enabled   | DontCapMyBill | Nill      | ACCEPTA | TEST ACCEPTA | Me       | Select | Not | Select | Not | Select | Not   | Not   | Select | Enabled | No        | Connected  | No          |
