Feature: 121_FR_Mix_CFU_Phone.feature
  ...
  Scenario Outline: 121_FR_Mix_CFU_Phone
    ...
    Examples:
      ...
      | in06684o_212094@o2.com | test123  | iPhone X | min     | min  | min  | skip   | TEST      | ACCEPTA | TEST ACCEPTA | low        | Disabled  | Monthly data (High to low) | A3 10      | Me       | Select | Not | Not | Not | Not  | Select | Not   | Not  | Enabled | No        | Connected  | No          |
