Feature: 45_Reg_CFU_ordering choice on upgrade options page_Phone_option_not selected
  ...
  Scenario Outline: This test ensures that customer is given a choice not to take a sim when the customer is on a phones upgrade journey
    ...
    Examples:
      ...
      | stester119a65f1cd-9cae-4087-acfc-dbe4f952980f@gmail.com | test123  | iPhone X | Enabled   | DontCapMyBill | Nill      | TEST ACCEPTA | skip   | 129.99upfront37.00amonth | Someone  | Select | Not | Not | Not | Not  | Not   | Not   | Not  | Enabled    | No        | Connected  | Yes         | No       |
