Feature: 89_Reg_Trustev_AFA_PAYM_Phones_WithAccessoryClick_and_Collect
  ...
  Scenario Outline: Trustev PayM Phones Click and collect E2E journey with Accessory in Agent shop
    ...
    Examples:
      ...
      | iPhone 7 Plus 128GB Black | Refresh | Enabled   | £20           | iPhone 7 Evo Elite Brushed Black | TEST      | ACCEPTA | 32          | SL11ER   | TEST ACCEPTA | test123  | test123          | Anything        | Select | Select | Not | Not | Not  | Select | Not   | Select | Me       | Enabled | test123  | test123         | Jkhan          | No        | Connected  | Phone        |
