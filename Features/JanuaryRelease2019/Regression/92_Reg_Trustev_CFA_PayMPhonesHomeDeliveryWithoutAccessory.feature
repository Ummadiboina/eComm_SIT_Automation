Feature: 92_Reg_Trustev_CFA_PayMPhonesHomeDeliveryWithoutAccessory
  ...
  Scenario Outline: Trustev PayM Phones Home delivery E2E journey without accessory
    ...
    Examples:
      ...
      | iPhone 8 Plus | Space Grey | 64GB     | TEST      | ACCEPTA | Enabled   | CapMyBill | DontCapMyBillLink | TEST ACCEPTA | Me       | Select | Not | Select | Not | Select | Select | Select | Select | Enabled    | No        | Connected  | No          | No       |