Feature: 50_CFU_Tablets_Data_filters_options_tariff_and_extras_page_Order_placement
  ...
  then the customer should be able to see  'Data filter' button next to sort drop-down for PayM tariffs
    ...
    Examples:
      | Tablet | Action | Surname | BSCstatus | BillCap   | CapAmount | Username     | filtername | sortoption                 | username                      | password | consumer | B1  | B2  | B3     | B4  | GDPRstatus | MBBStatus | DeviceType | PreSelected | KeyEvent |
      | A3 10  | skip   | ACCEPTA | Enabled   | CapMyBill | £100      | TEST ACCEPTA | low        | Monthly data (Low to High) | 10au66996482@stf.ref.o2.co.uk | test123  | Me       | Not | Not | Select | Not | Enabled    | No        | Connected  | No          | No       |
