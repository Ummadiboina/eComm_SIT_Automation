...
#AND veriy Confirmation Page
    ...
    Examples:
      | Firstname | Surname | Username     | Status   | consumer | accessoryname | limit1 | B1  | B2  | B3  | B4  | Text | Email | Phone | Post | status   | MBBStatus | DeviceType    |
      | TEST      | ACCEPTA | TEST ACCEPTA | In Stock | Me       | Random        | 2      | Not | Not | Not | Not | Not  | Not   | Not   | Not  | Disabled | No        | Non Connected |
