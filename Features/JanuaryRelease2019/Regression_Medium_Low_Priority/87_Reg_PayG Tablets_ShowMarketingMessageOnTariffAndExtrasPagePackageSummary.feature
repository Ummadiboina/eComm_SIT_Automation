Feature:87_Reg_PayG Tablets_ShowMarketingMessageOnTariffAndExtrasPagePackageSummary
  ...
  Scenario Outline: PayG Tablets_ShowMarketingMessageOnTariffAndExtrasPagePackageSummary
    ...
    Examples:
      | Device           | Firstname | Surname | Username     | BSCstatus | PaymentSectionName | AgreementSectionName | tariff        | consumer | B1     | B2     | B3     | B4  | Text   | Email  | Phone | Post | status  | MBBStatus | DeviceType | PreSelected |
      | Galaxy Book 10.6 | TEST      | ACCEPTA | TEST ACCEPTA | Disabled  | Payment Page       | Order Summary        | 1GB Preloaded | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | No        | Connected  | No          |