Feature: 11_Reg_CFA_Phones_SSC_checkout_pages_mark_mandatory_fields_with_asterisk
  ...
  Scenario Outline: CFA_Phones_SSC_checkout_pages_mark_mandatory_fields_with_asterisk
   ...
   # And click on the color dropdown
    ...
    Examples:
      | handset   | Firstname | Surname | consumer | B1     | B2  | B3  | B4  | Text   | Email | Phone | Post | status  | MBBStatus | DeviceType |
      | Galaxy S8 | Test      | Accepta | Me       | Select | Not | Not | Not | Select | Not   | Not   | Not  | Enabled | No        | Connected  |
