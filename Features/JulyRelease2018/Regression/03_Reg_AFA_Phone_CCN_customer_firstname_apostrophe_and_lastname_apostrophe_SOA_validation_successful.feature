Feature: 03_Reg_AFA_Phone_CCN_customer_firstname_apostrophe_and_lastname_apostrophe_SOA_validation_successful
  ...
  Scenario Outline: ConsumerShopToAcceptApostrophe
    ...
    Examples:
      ...
      | Galaxy S8 Plus 64GB Midnight Black | Refresh | Base   | HomeDelivery | TEST'One  | ACCEPTA'Two | TEST ACCEPTA | 14          | SL11UP   | Not | Not | Not | Not | Not  | Not   | Not   | Not  | Someone  | Enabled | No        | Connected  | Phone        |
