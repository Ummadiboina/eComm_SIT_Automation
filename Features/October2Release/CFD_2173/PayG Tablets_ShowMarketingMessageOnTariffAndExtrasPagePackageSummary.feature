Feature: PayG Tablets_ShowMarketingMessageOnTariffAndExtrasPagePackageSummary
  ...
  Scenario Outline: PayG Tablets_ShowMarketingMessageOnTariffAndExtrasPagePackageSummary
    ...
    Examples:
      | handset | Firstname | Surname | Username     | tariff | TileName | SectionName | BasketSectionName | DeliverySectionName | PaymentSectionName | AgreementSectionName | ReviewSectionName |
