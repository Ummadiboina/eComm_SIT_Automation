Feature: C1960_E11522_TC5_CFA_Other_tablets_tab_basecomms_tariffs_Basket_Checkout_login_order_placement_O2_offer
  ...
  Scenario Outline: This scenario ensures that when the customer adds Basecomm tariff for tablets to the basket from my offers page, then the customer should be prompted to login from basket page and should be able to place order
