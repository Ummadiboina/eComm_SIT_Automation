...
Scenario Outline:
This scenario ensures that when the customer adds Basecomm tariff for iPad to the basket from my offers page, then the customer should be prompted to login from basket page and should be able to place order 
