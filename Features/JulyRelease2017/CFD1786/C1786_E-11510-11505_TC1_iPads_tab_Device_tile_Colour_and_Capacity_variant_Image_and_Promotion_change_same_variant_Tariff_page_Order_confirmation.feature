...
Scenario Outline: 
	This scenario ensures that when the existing customer lands on new basecomm page selects "iPads" tab and Change the Variant of the device, 
	...
	Examples: 
		...
		| inavl0wx_355207@o2.com | test123  | Apple iPad 9.7| Space Grey| 32GB|In Stock|Space Grey|128GB    | TEST ACCEPTA |
