Feature: 02_CFA_Tablet_Simo_Edit_and_Validate_BSC_Component_In_Tariff_Listing_and_Basket_Page
  ...
  @Web
  Scenario Outline: 02_CFA_Tablet_Simo_Edit_and_Validate_BSC_Component_In_Tariff_Listing_and_Basket_Page
    ...
    Examples:
      ...
      | 30 Days  | TEST      | ACCEPTA | TEST ACCEPTA | DontCapMyBill | Nill      | CapMyBill  | £20          | Enabled   | Me       | Not | Not | Select | Not | Not  | Select | Not   | Select | Enabled | No        | Connected  |
