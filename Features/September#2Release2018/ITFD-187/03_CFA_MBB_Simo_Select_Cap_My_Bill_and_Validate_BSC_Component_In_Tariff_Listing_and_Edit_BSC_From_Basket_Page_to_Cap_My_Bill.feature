Feature: 03_CFA_MBB_Simo_Select_Cap_My_Bill_and_Validate_BSC_Component_In_Tariff_Listing_and_Edit_BSC_From_Basket_Page_to_Cap_My_Bill
  ...
  @Web
  Scenario Outline: 03_CFA_MBB_Simo_Select_Cap_My_Bill_and_Validate_BSC_Component_In_Tariff_Listing_and_Edit_BSC_From_Basket_Page_to_Cap_My_Bill
    ...
    And Validate and click on BSC 'Edit' link to change <NewBillCap> <NewCapAmount>
