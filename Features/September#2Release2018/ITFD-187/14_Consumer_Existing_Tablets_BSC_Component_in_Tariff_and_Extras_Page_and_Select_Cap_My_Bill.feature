Feature: 14_Consumer_Existing_Tablets_BSC_Component_in_Tariff_and_Extras_Page_and_Select_Cap_My_Bill
  ...
  Scenario Outline: 14_Consumer_Existing_Tablets_BSC_Component_in_Tariff_and_Extras_Page_and_Select_Cap_My_Bill
    ...
    Examples:
      ...
      | ins_feb8544@stf.ref.o2.co.uk | test123  | Galaxy Tab S3 9.7 | 11          | SL11ER   | CapMyBill | £5        | DontCapMyBill | Nill         | Enabled   | TEST ACCEPTA | enterCode | 129.99upfront37.00amonth | Somone   | Not | Not | Not | Not | Not  | Not   | Not   | Not  | Enabled | No        | Connected  |
