Feature: 11_CFU_Tablets_BSC_Component_in_Upgrade_Options_Page_and_Select_Do_Not_Cap_My_Bill

  This scenario ensures that consumer in upgrade journey of tablet with tariff is able to view BSC component and select do not cap my bill and place the order successfully

  @Web
  Scenario Outline: 11_CFU_Tablets_BSC_Component_in_Upgrade_Options_Page_and_Select_Do_Not_Cap_My_Bill
    ...
    Examples:
      ...
      | in01808o_223437@o2.com | test123  | Galaxy Tab S3 9.7 | 11          | SL11ER   | DontCapMyBill | Nill      | Enabled   | TEST ACCEPTA | enterCode | 129.99upfront37.00amonth | Me       | Select | Select | Select | Not | Select | Select | Select | Select | Enabled | No        | Connected  |
