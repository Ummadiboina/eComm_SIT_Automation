Feature: 21_CFA_MBB_Edit_BSC_Component_from_Basket_Page_and_Select_Cap_My_Bill_and_Validate_Values

  This scenario ensures that consumer in Acquisition journey of MBB with tariff is able to edit the BSC component from Basket page and select cap my bill and place the order successfully and validate the PDF file

  @Web
  Scenario Outline: 21_CFA_MBB_Edit_BSC_Component_from_Basket_Page_and_Select_Cap_My_Bill_and_Validate_Values
  GGiven I am an CFA user and Lands on shop page
    ...
    Examples:
      | Device_Name   | Firstname | Surname | Username     | BillCap   | CapAmount | NewCapAmount | BSCstatus | color      | consumer | B1  | B2  | B3     | B4  | Text | Email  | Phone | Post | status  | MBBStatus | DeviceType |
      | Random Device | TEST      | ACCEPTA | TEST ACCEPTA | CapMyBill | £5        | £10          | Enabled   | Space Grey | Me       | Not | Not | Select | Not | Not  | Select | Not   | Not  | Enabled | No        | Connected  |
