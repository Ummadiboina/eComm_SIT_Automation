Feature: 16_Reg_CFU_Buyout_with_Recycle_Order_placement
  ...
  Scenario Outline: CFU_Buyout_with_Recycle_Order_placement
    ...
    Examples:
      ...
      | Random Device | skip   | ACCEPTA | TEST ACCEPTA | Disabled  | iPhone 8 | Delivery | Payment | low        | Monthly data (Low to High) | 07se64045551@stf.ref.o2.co.uk | test123  | SomeOne else | Select | Select | Not | Not | Not  | Select | Not   | Select | Enabled | No        | Connected  |
