Feature: 50_CFU_Tablets_Data_filters_options_tariff_and_extras_page_Order_placement
  ...
  then the customer should be able to see  'Data filter' button next to sort drop-down for PayM tariffs
    ...
    Examples:
      ...
      | Galaxy Tab S3 9.7 | skip   | ACCEPTA | Enabled   | TEST ACCEPTA | low        | Monthly data (Low to High) | rbmuatlokesh_donotusee3196 | test123  | Me       | Not | Not | Select | Not | Not  | Select | Not   | Not  | Enabled | No        | Connected  |
