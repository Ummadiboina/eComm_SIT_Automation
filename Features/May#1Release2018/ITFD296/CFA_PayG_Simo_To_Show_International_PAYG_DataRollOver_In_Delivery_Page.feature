Feature: CFA_PayG_Simo_To_Show_International_PAYG_DataRollOver_In_Delivery_Page
  This scenario ensures that when the customer on acquisition journey selects International Sim
  then Data Roll over copy text is displayed in the tile info and Delivery page

  @Web
  Scenario Outline: CFA_PayG_Simo_To_Show_International_PAYG_DataRollOver_In_Delivery_Page
