Feature: Reg_VOLTE_PayMPhonesHomeDeliveryWithoutAccessory.feature
  ...
  Scenario Outline: Volte PayM Phones Home delivery E2E journey without accessory
    ...
    Examples:
      ...
      | Galaxy  | TEST      | ACCEPTA | TEST ACCEPTA | Me       | Not | Not | Select | Not | Not  | Select | Not   | Not  | Enabled | No        | Connected  |
