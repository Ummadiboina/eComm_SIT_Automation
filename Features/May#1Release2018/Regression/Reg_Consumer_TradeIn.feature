Feature: Reg_Consumer_TradeIn
  ...
  Scenario Outline: This scenario ensures that the customer is able to successully Trade In the device
    ...
    Examples:
      ...
      | 23oc30086819@stf.ref.o2.co.uk | test123  | iPhone X | 19.99upfront45.00amonth | OTAC | Delivery | Payment | Agreement | Review | TEST ACCEPTA | enterCode | Me       | Select | Not | Select | Not | Not  | Select | Not   | Not  | Enabled | No        | Connected  |
