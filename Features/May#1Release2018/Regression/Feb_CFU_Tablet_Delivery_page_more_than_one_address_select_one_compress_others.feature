Feature: Feb_CFU_Tablet_Delivery_page_more_than_one_address_select_one_compress_others
  ...
  Scenario Outline: CFU_user_with_direct_debit_details_SIMO_order_Tablets_user_Review_page_changes
    ...
    Examples:
      ...
      | 1161252@gmail.com | test123  | Random Device | 9.99upfront60.00amonth | 111         | SL11Er   | Test Accepta | enterCode | Me       | Not | Not | Select | Not | Not  | Select | Not   | Select | Enabled | No        | Connected  |
