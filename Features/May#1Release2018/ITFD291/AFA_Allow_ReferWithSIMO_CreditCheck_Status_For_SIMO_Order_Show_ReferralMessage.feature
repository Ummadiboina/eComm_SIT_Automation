Feature: AFA_Allow_ReferWithSIMO_Credit_Check_Status_For_SIMO_Order_And_Show_ReferralMessage
  ...
  Scenario Outline: AFA_Allow_ReferWithSIMO_Credit_Check_Status_For_SIMO_Order_And_Show_ReferralMessage
    ...
    Examples:
      | Tariff | DeliveryType | Firstname | Surname          | Username     | HouseNumber | PostCode | B1     | B2  | B3     | B4     | Text   | Email  | Phone | Post | Consumer | status  | MBBStatus |
      | SimO   | HomeDelivery | TEST      | ReferralwithSimo | TEST ACCEPTA | 6           | SL11ER   | Select | Not | Select | Select | Select | Select | Not   | Not  | Me       | Enabled | No        |
