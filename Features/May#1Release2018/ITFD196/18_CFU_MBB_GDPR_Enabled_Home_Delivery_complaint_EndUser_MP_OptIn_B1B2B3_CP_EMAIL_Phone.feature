Feature: 18_CFU_MBB_GDPR_Enabled_Home_Delivery_complaint_EndUser_MP_OptIn_B1B2B3_CP_EMAIL_Phone
  ...
  Scenario Outline: 18_CFU_MBB_GDPR_Enabled_Home_Delivery_complaint_EndUser_MP_OptIn_B1B2B3_CP_EMAIL_Phone
    ...
    Examples:
      | Tablet        | Action | Surname | Username     | filtername | sortoption                 | username                      | password |consumer| B1     | B2     | B3     | B4  | Text| Email | Phone  | Post |Device_Name|status|
      | Random Device | skip   | ACCEPTA | TEST ACCEPTA | low        | Monthly data (Low to High) | identityref01@mailinator.com  | test123  |Me      | Select | Select | Select | Not |Not  |Select | Select | Not  |           |Enabled|
