Feature: 14_CFU_SIMO_Reaffirmed_Review_Page_Home_Delivery_GDPR_Enabled_Not_EndUser_MP_Suppressed
  ...
  @Web
  Scenario Outline: 14_CFU_SIMO_Reaffirmed_Review_Page_Home_Delivery_GDPR_Enabled_Not_EndUser_MP_Suppressed
    ...
    Examples:
      ...
      | 30 Days  | 12342015@gmail.com | test123  | low        | Monthly data (High to low) |SomeOne else| Not    | Not | Not    | Not |Not|Not | Not | Not|