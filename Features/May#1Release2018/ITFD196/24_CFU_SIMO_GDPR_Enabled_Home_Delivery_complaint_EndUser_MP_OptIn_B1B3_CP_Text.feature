Feature: 24_CFU_SIMO_GDPR_Enabled_Home_Delivery_complaint_EndUser_MP_OptIn_B1B3_CP_Text
  ...
  @Web
  Scenario Outline: 24_CFU_SIMO_GDPR_Enabled_Home_Delivery_complaint_EndUser_MP_OptIn_B1B3_CP_Text
    ...
    Examples:
      ...
      | 30 Days  | 12342015@gmail.com | test123  | low        | Monthly data (High to low) |SomeOne else| Select | Not | Select | Not |Select|Not | Not | Not|