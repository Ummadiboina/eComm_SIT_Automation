Feature: 17_CFU_MBB_GDPR_Enabled_Hme_Delivery_complaint_Not_EndUser_MP_Suppressed
  ...
  Scenario Outline: 17_CFU_MBB_GDPR_Enabled_Hme_Delivery_complaint_Not_EndUser_MP_Suppressed
    ...
    Examples:
      ...
      | Random Device | skip   | ACCEPTA | TEST ACCEPTA | low        | Monthly data (Low to High) | identityref01@mailinator.com  | test123  |SomeOne else  | Not | Not | Not | Not |Not|Not | Not | Not|           |Enabled|Yes               |
