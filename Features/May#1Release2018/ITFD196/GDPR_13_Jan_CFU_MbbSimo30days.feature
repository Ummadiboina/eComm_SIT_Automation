Feature: GDPR_13_Jan_CFU_MbbSimo30days.feature
  ...
  Scenario Outline: CFU_MbbSimo30days
    ...
    Examples:
      ...
      | 30 Days  | 12342015@gmail.com | test123  | low        | Monthly data (High to low) |    Me  | Select | Select | Select | Select |Select|Select | Select | Select|