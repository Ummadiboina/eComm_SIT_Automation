Feature: GDPR_21__CFD2064_ECOM11810_11811_CFU_ordering choice on upgrade options page_Phone_Option selected
  ...
  Scenario Outline: This test ensures that customer is given a choice to take a sim when the customer is on a phones upgrade journey
    ...
    Examples:
      ...
      | ash@o2.com       | test123  | Samsung Galaxy S8 | TEST ACCEPTA | skip   |      |    Me  | Select | Select | Select | Select |Select|Select | Select | Select|
