Feature: AFA_Multiple_Basket_CnC_Email_basket_Get_Basket_Link
  ...
  Scenario Outline: AFA_Multiple_Basket_CnC_Email_basket_Get_Basket_Link
    ...
    Examples:
      | Device1                | Tariffs1 | Device2             | Tariffs2 | Device3                 | Tariffs3 | Device4       | Firstname | Surname | Username     | HouseNumber | PostCode | DeliveryType | B1  | B2  | B3  | B4  | Text | Email    | Phone     | Post |Consumer    |status|MBBStatus|
      | Samsung Galaxy S9 Plus | Refresh  | Apple iPhone 7 Plus | Refresh  | iPhone 8 Plus 64GB Gold | Standard | Fitbit Flex 2 | TEST      | ACCEPTA | TEST ACCEPTA | 11          | SL11UP   | HomeDelivery | Not | Not | Not | Not |Not|Not | Not | Not|SomeOne else|Enabled|No                       |
