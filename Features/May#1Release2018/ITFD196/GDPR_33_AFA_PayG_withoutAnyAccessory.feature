Feature: GDPR_33_AFA_PayG_withoutAnyAccessory
  ...
  Scenario Outline: Successful completion of a PAY G handset acquisition Journey without an accessory
    ...
    Examples:
      ...
      | iPhone 6s 32GB Gold | Random  | HomeDelivery | TEST      | ACCEPTA | 4           | SL11UP   | Not | Not | Select | Select |Not |Select | Select | Not|Me      |
