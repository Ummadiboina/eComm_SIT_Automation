Feature: 23_CFU_SIMO_Migrated_Review_Page_Home_Delivery_GDPR_Disabled_Donot_show_EndUser_Question
  ...
  @Web
  Scenario Outline: 23_CFU_SIMO_Migrated_Review_Page_Home_Delivery_GDPR_Disabled_Donot_show_EndUser_Question
