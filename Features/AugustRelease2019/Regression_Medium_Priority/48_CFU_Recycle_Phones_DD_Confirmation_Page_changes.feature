Feature: 48_CFU_Recycle_Phones_DD_Confirmation_Page_changes
  ...
  then the customer should be able to see the changes in 'Confirmation Page formatting box'
    ...
    Examples:
      ...
      | testaccepta3301@stf.ref.o2.co.uk | test123  | Enabled   | CapMyBill | £5        | iPhone 6s | 29.99upfront60.34amonth | TEST      | ACCEPTA | TEST ACCEPTA | skip   | Delayed Delivery | Apple | Iphone7 | Orange  | Me       | Not | Select | Not | Not | Select | Not   | Not   | Not  | Enabled    | No        | Connected  | Yes         | No       |
