Feature: 04_CFU_Tablet_SIMO_Skip_OTAC_Code_For_DifferentDeliveryAddress
  ...
  OTAC page and skip otac code then customer should redirect to 'Review and Confirm' page and should not see delivery input fields

  @Web
  Scenario Outline: 04_CFU_Tablet_SIMO_Skip_OTAC_Code_For_DifferentDeliveryAddress
    ...
    Examples:
      ...
      | 12 Months      | 10oc57974752@stf.ref.o2.co.uk | Enabled   | CapMyBill | £200      | test123  | skip   |