Feature: 06_CFU_Refresh_Customer_Phone_SIMO_Enter_OTAC_Code_For_DifferentDeliveryAddress


  @Web
  Scenario Outline: 06_CFU_Refresh_Customer_Phone_SIMO_Enter_OTAC_Code_For_DifferentDeliveryAddress
    ...
    Examples:
      ...
      | gb083240_535919@o2.com | enterCode | test123  | DontCapMyBill | Nill      | Enabled   | 12 Months      |
