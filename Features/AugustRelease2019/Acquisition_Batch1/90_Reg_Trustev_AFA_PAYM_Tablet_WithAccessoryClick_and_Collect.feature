Feature: 90_Reg_Trustev_AFA_PAYM_Tablet_WithAccessoryClick_and_Collect
  ...
  Scenario Outline: Trustev PayM Tablets Click and Collect E2E journey with Accessory in Agent shop
    ...
    Examples:
      ...
      | Galaxy Tab A 10.5 | Refresh | Enabled   | £100          | Samsung S9 Crystal Bundle | TEST      | ACCEPTA | 32          | SL11ER   | TEST ACCEPTA | test123  | test123          | Anything        | Not | Not | Select | Not | Not  | Not   | Select | Select | Me       | Enabled | test123  | test123         | Jkhan          | No        | Connected  | Tablet       |
