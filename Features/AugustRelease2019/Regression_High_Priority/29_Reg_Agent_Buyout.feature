Feature: 29_Reg_Agent_Buyout
  ...
  Scenario Outline: Successful completion of a BuyOut Journey
    ...
    Examples:
      ...
      | 07568418378 | Apple iPhone 7 Plus 32GB Rose Gold | Enabled   | £15           | Refresh | test76435026@stf.ref.o2.co.uk | HomeDelivery | Test      | Accepta | Flat 9      | SL11EL   | Test Accepta | test123  | Me       | Not | Not | Select | Not | Select | Select | Select | Select | Enabled | No        | Connected  | No          |