Feature: 128_BSC_Consumer_Existing_Tablets_BSC_Component_in_Tariff_and_Extras_Page_and_Select_Cap_My_Bill
  ...
  Scenario Outline: 128_BSC_Consumer_Existing_Tablets_BSC_Component_in_Tariff_and_Extras_Page_and_Select_Cap_My_Bill
    ...
    Examples:
      ...
      | acce91642277@stf.ref.o2.co.uk | test123  | Galaxy Tab A 10.5 | 11          | SL11ER   | CapMyBill | £5        | CapMyBill  | DontCapMyBillLink | Enabled   | TEST ACCEPTA | enterCode | 129.99upfront37.00amonth | Somone   | Select | Select | Select | Not | Not  | Not   | Not   | Not  | Enabled    | No        | Connected  | No          | No       |
