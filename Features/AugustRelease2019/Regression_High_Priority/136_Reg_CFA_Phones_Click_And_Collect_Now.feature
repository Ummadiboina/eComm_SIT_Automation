Feature: 136_Reg_CFA_Phones_Click_And_Collect_Now
  ...
  Scenario Outline: 136_Reg_CFA_Phones_Click_And_Collect_Now
    ...
    Examples:
      ...
      | iPhone Xs Max | TEST ACCEPTA | Test      | Accepta | Orchid Grey | 64GB     | Me       | Enabled   | CapMyBill | £0        | Select | Select | Not | Not | Select | Select | Select | Select | Enabled    | No        | Connected  | No          | No       |