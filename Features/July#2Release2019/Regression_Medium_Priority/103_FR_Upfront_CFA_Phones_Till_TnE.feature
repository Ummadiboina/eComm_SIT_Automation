Feature: 103_FR_Upfront_CFA_Phones_Till_TnE.feature

  @Web
  Scenario Outline: 103_FR_Upfront_CFA_Phones_Till_TnE
    ...
    Examples:
      ...
      | Galaxy Note9 | Test Accepta | £39       | 8GB       | Ocean Blue | Test      | Accepta | Me       | Enabled   | Select | Not | Not | Not | Select | Not   | Not   | Not  | Enabled    | No        | Connected  | min     | max  | min  | No          | No       |
