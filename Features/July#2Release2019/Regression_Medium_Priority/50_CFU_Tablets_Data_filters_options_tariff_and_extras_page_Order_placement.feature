Feature: 50_CFU_Tablets_Data_filters_options_tariff_and_extras_page_Order_placement
  ...
  then the customer should be able to see  'Data filter' button next to sort drop-down for PayM tariffs
    ...
    Examples:
      ...
      | iPad 9.7 inch 2018 | skip   | Space Grey | 512GB    | ACCEPTA | Enabled   | CapMyBill | £100      | TEST ACCEPTA | high       | Monthly data (High to low) | e2ed92552501@stf.ref.o2.co.uk | test123  | Me       | Not | Not | Select | Not | Not  | Select | Not   | Not  | Enabled    | No        | Connected  | No          | No       |
