Feature: 118_FR_Upfront_CFA_PayMTablets_Till_TnE.feature
  ...
  Scenario Outline: 118_FR_Upfront_CFA_PayMTablets_Till_TnE
    ...
    Examples:
      ...
      | iPad 9.7 inch 2018 | Test Accepta | £39       | 8GB       | Space Grey | Test      | Accepta | Me       | Enabled   | Select | Not | Not | Not | Select | Not   | Not   | Not  | Enabled    | No        | Connected  | avg     | max  | max  | No          | No       |
