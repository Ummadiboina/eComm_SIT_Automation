Feature: 141_CFA_Phone_PAYGClassicTariff_Basketpage_CNCnow_eligible
  ...
  @Web
  Scenario Outline: 141_CFA_Phone_PAYGClassicTariff_Basketpage_CNCnow_eligible
    ...
    Examples:
      ...
      | Galaxy S10 | Space Grey | TEST      |        | Disabled  | ACCEPTA | TEST ACCEPTA | Me       | Not | Select | Not | Not | Not  | Select | Not   | Not  | Enabled    | No        | Connected  | No          | No       |
