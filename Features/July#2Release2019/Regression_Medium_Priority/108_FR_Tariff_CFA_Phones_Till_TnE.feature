Feature: 108_FR_Upfront_CFA_Phones_Till_TnE.feature

  @Web
  Scenario Outline: 108_FR_Upfront_CFA_Phones_Till_TnE
    ...
    Examples:
      ...
      | iPhone 7 Plus | Test Accepta | £39       | 8GB       | Silver | Test      | Accepta | Me       | Enabled   | Select | Not | Not | Not | Select | Not   | Not   | Not  | Enabled    | No        | Connected  | max     | max  | avg  | No          | No       |
