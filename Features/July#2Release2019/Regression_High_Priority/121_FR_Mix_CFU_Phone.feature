Feature: 121_FR_Mix_CFU_Phone.feature
  ...
  Scenario Outline: 121_FR_Mix_CFU_Phone
    ...
    Examples:
      ...
      | e2ed01930381@stf.ref.o2.co.uk | test123  | Galaxy S9 | min     | min  | min  | skip   | TEST      | ACCEPTA | TEST ACCEPTA | low        | Disabled  | Monthly data (High to low) | A3 10      | Me       | Select | Not | Not | Not | Not  | Select | Not   | Not  | Enabled    | No        | Connected  | Yes         | No       |
