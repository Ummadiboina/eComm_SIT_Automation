Feature: 66_Reg_CFU_PayMSimOnly
  ...
  Scenario Outline: CFU_PhonesSimo30day
    ...
    Examples:
      ...
      | 30 Days        | Configured | in0321e8_180534@o2.com | Enabled   | CapMyBill | £30       | TEST ACCEPTA | test123  | high       | Monthly data (Low to High) | Me       | Select | Not | Select | Not | Not  | Select | Not   | Not  | Enabled    | No        | Connected  | No          | No       |