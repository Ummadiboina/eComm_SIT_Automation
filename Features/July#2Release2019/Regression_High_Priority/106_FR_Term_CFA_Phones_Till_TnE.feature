Feature: 106_FR_Upfront_CFA_Phones_Till_TnE.feature
  ...
  Scenario Outline: 101_FR_Upfront_CFA_Phones_Till_TnE
    ...
    Examples:
      ...
      | iPhone XR | Test Accepta | £39       | 8GB       | Black | Test      | Accepta | Me       | Enabled   | Select | Not | Not | Not | Select | Not   | Not   | Not  | Enabled    | No        | Connected  | avg     | min  | avg  | No          | No       |
