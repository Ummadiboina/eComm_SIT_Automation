Feature: 33_CFA_PayG_Phones_Validate_OFCOM_With_InValid_STAC_Code_When_OfCom_Enabled
  ...
  Scenario Outline:33_CFA_PayG_Phones_Validate_OFCOM_With_InValid_STAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | iPhone XR | TEST      | ACCEPTA |        | Phone   | Enabled     | Yes          | Invalid    | STAC        | Yes                 | 07707003650    | 965998XBA   | Disabled  |
