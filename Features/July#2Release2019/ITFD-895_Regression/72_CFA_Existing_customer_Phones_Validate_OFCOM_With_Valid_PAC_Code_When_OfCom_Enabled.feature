Feature: 72_CFA_Existing_customer_Phones_Validate_OFCOM_With_Valid_PAC_Code_When_OfCom_Enabled
  ...
  Scenario Outline: 72_CFA_Existing_customer_Phones_Validate_OFCOM_With_Valid_PAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | Galaxy S9 | Space Grey | 512GB    | Enabled   | CapMyBill | £60       | dono73655651@stf.ref.o2.co.uk | test123  | TEST ACCEPTA | Phone   | Enabled     | Yes          | valid      | PAC         | Yes                 | 07521141016    | XBA388908   |
