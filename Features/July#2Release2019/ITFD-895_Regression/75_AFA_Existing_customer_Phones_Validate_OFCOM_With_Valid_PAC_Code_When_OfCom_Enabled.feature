Feature: 75_AFA_Existing_customer_Phones_Validate_OFCOM_With_Valid_PAC_Code_When_OfCom_Enabled
  ...
  Scenario Outline: 75_AFA_Existing_customer_Phones_Validate_OFCOM_With_Valid_PAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | 07521137996 | iPhone 8 Plus 64GB Space Grey | Refresh | Insurance | Enabled   | £30           | TEST ACCEPTA | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | AFA     | Connected  | Phone        | Enabled     | Yes          | 07521139484    | valid      | PAC         | XBA551657   | Yes                 |
