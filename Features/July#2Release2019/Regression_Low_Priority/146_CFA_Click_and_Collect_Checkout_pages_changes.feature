Feature: 146_CFA_Click_and_Collect_Checkout_pages_changes
  ...
  @Web
  Scenario Outline: 146_CFA_Click_and_Collect_Checkout_pages_changes
    ...
    Examples:
      ...
      | iPhone 8 Plus | TEST ACCEPTA | Test      | Accepta | Space Grey | Me       | Enabled   | CapMyBill | £0        | Select | Select | Not | Not | Select | Select | Select | Select | Enabled    | No        | Connected  | No          | No       |
