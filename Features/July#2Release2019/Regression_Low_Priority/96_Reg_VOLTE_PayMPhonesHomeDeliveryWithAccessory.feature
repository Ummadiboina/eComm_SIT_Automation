Feature: 96_Reg_VOLTE_PayMPhonesHomeDeliveryWithAccessory
  ...
  Scenario Outline: CFA PayM Phones Home delivery E2E journey with Accessory
    ...
    Examples:
      | handset      | color          | Capacity | Firstname | Surname | Username     | BSCstatus | BillCap   | CapAmount | consumer | B1  | B2  | B3     | B4  | Text   | Email | Phone | Post | GDPRstatus | MBBStatus | DeviceType | PreSelected | KeyEvent |
      | Galaxy Note9 | Midnight Black | 128GB    | TEST      | ACCEPTA | TEST ACCEPTA | Enabled   | CapMyBill | £20       | Me       | Not | Not | Select | Not | Select | Not   | Not   | Not  | Enabled    | No        | Connected  | No          | No       |
