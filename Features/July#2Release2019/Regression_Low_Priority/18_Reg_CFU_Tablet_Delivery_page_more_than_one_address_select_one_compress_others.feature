Feature: 18_Reg_CFU_Tablet_Delivery_page_more_than_one_address_select_one_compress_others
  ...
  Scenario Outline: CFU_user_with_direct_debit_details_SIMO_order_Tablets_user_Review_page_changes
    ...
    Examples:
      ...
      | in01808o_701268@o2.com | test123  | iPad 9.7 inch 2018 | Enabled   | CapMyBill | £60       | Gold  | 9.99upfront60.00amonth | 100         | SL11ER   | Test Accepta | enterCode | Me       | Select | Not | Not | Not | Not  | Select | Not   | Select | Enabled    | No        | Connected  | No          | No       |
