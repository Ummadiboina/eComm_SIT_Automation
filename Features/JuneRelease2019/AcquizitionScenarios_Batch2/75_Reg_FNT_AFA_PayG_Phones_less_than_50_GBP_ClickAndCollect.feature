Feature: 75_Reg_FNT_AFA_PayG_Phones_less_than_50_GBP_ClickAndCollect
  ...
  @Web
  Scenario Outline: This test scenario ensures that PaynGo order via the web for payment less than 50 GBP where Click and Collect
    ...
    Examples:
      ...
      | Galaxy J5 2017 Black | In stock | Disabled  | 50      | TEST      | ACCEPTA | 4           | sl11er   | Select | Not | Select | Not | Not  | Select | Select | Not  | Me       | Enabled | test123  | test123         | Jkhan          | No        | Connected  | Phone        |
