Feature: 47_AFA_PayG_Phones_Validate_OFCOM_With_Valid_STAC_Code_When_OfCom_Enabled
  ...
  Scenario Outline: 47_AFA_PayG_Phones_Validate_OFCOM_With_Valid_STAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | iPhone 8 Plus 64GB Space Grey | Random  | Insurance | Disabled  | HomeDelivery | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | Phones  | Connected  | Phone        | Enabled     | Yes          | 07412321774    | valid      | STAC        | 584477XCR   | Yes                 |
