Feature: 45_AFA_Phones_Validate_OFCOM_With_Valid_STAC_Code_When_OfCom_Enabled
  ...
  Scenario Outline: 45_AFA_Phones_Validate_OFCOM_With_Valid_STAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | Galaxy S8 Plus 64GB Midnight Black | Refresh | Random    | Insurance | HomeDelivery | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | AFA     | Connected  | Phone        | Enabled     | Yes          | 07412321773    | valid      | STAC        | 701889XCR   | Yes                 |
