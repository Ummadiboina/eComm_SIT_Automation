Feature: 46_AFA_PayG_Phones_Validate_OFCOM_With_Valid_PAC_Code_When_OfCom_Enabled
  ...
  Scenario Outline: 46_AFA_PayG_Phones_Validate_OFCOM_With_Valid_PAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | iPhone 8 Plus 64GB Space Grey | Random  | Random    | Disabled  | HomeDelivery | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | Phones  | Enabled     | Yes          | 07707003218    | XBA458946   | Yes                 | test1234        | test1234 | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | Connected  | Phone        | valid      | PAC         |
