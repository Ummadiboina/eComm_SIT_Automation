Feature: 65_AFA_Generate_CCA_Link_For_Phones_And_Validate_OFCOM_With_Valid_STAC_Code_When_OfCom_Enabled

  #launch hooks and get browser
  @Web
  Scenario Outline: 65_AFA_Generate_CCA_Link_For_Phones_And_Validate_OFCOM_With_Valid_STAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | iPhone 7 Plus 32GB Rose Gold | Refresh | Enabled   | £100          | HomeDelivery | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test123  | test123         | vinudeep       | Select | Select | Select | Not | Select | Select | Select | Select | Me       | Enabled    | Disabled    | ink_jun8829@stf.ref.o2.co.uk | test123  | Connected  | Phone        | Yes         | No       | AFA     | CCA      | Enabled     | Yes          | Yes                 | 07707003267    | 071026XBA   | valid      | STAC        |
