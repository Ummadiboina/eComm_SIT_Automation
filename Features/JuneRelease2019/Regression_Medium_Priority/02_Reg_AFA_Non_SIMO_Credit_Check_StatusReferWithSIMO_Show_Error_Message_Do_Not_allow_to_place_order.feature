Feature: 02_Reg_AFA_Non_SIMO_Credit_Check_StatusReferWithSIMO_Show_Error_Message_Do_Not_allow_to_place_order
  ...
  Scenario Outline: AFA_update_copy_for_Refer_with_Simo_response
    ...
    Examples:
      ...
      | Galaxy S9 Plus 128GB Midnight Black | Refresh | HomeDelivery | Enabled   | No spend cap  | TEST      | referc  | Test Referc | 6           | SL11ER   | Select | Not | Select | Select | Select | Select | Not   | Not  | Someone  | Enabled | No        | Connected  | simo         |
