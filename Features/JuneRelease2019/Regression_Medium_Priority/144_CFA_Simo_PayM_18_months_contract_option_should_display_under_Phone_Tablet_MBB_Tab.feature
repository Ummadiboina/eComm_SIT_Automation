Feature:144_CFA_Simo_PayM_18_months_contract_option_should_display_under_Phone_Tablet_MBB_Tab
  ...
  @Web
  Scenario Outline:144_CFA_Simo_PayM_18_months_contract_option_should_display_under_Phone_Tablet_MBB_Tab
    ...
    Examples:
      ...
      | 18 Months | TEST      | ACCEPTA | TEST ACCEPTA | Enabled   | CapMyBill | £15       | Not | Not | Not | Not | Not  | Not   | Not   | Not  | Enabled    | No        | Connected  | No          | No       |
