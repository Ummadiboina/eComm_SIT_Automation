Feature: 5_Validate_STAC_Form_with_Locked_Stac_Code

  5_Validate_STAC_Form_with_Locked_Stac_Code

  @Web
  Scenario Outline:5_Validate_STAC_Form_with_Locked_Stac_Code
    ...
    Examples:
      ...
      | 07345107531 | 999999       | 07707003294 | 273566XBA | Pay As You Go |                 | Test      | Accepta  | Random  | Locked          |
