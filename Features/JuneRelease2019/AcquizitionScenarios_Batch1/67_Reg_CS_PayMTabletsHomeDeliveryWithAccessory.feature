Feature: 67_Reg_CS_PayMTabletsHomeDeliveryWithAccessory
  ...
  Scenario Outline: PayM Tablets Home delivery E2E journey with Accessory
    ...
    Examples:
      ...
      | iPad 9.7 inch 2018 | Space Grey | 256GB    | Enabled   | DontCapMyBill | Nill      | TEST      | ACCEPTA | TEST ACCEPTA | Me       | Not | Select | Not | Not | Select | Select | Not   | Not  | Enabled    | No        | Connected  | No          | No       |
