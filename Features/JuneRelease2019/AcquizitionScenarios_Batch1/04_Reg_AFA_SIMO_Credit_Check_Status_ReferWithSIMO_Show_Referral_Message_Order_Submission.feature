Feature: 04_Reg_AFA_SIMO_Credit_Check_Status_ReferWithSIMO_Show_Referral_Message_Order_Submission
  ...
  Scenario Outline: AFA_Allow_ReferWithSIMO_Credit_Check_Status_For_SIMO_Order_And_Show_ReferralMessage
    ...
    Examples:
      | Tariff | DeliveryType | Firstname | Surname | Username    | BSCstatus | BillCapAmount | HouseNumber | PostCode | B1     | B2  | B3     | B4  | Text   | Email  | Phone | Post | Consumer | status  | MBBStatus | DeviceType | DeviceModule |
      | Simo   | HomeDelivery | TEST      | Referc  | Test Referc | Enabled   | £20           | 6           | SL11ER   | Select | Not | Select | Not | Select | Select | Not   | Not  | Me       | Enabled | No        | Connected  | Simo         |