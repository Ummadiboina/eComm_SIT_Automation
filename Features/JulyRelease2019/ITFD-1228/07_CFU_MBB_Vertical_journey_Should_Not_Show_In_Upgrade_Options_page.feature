Feature: 07_CFU_MBB_Vertical_journey_Should_Not_Show_In_Upgrade_Options_page
  ...
  @Web
  Scenario Outline: 07_CFU_MBB_Vertical_journey_Should_Not_Show_In_Upgrade_Options_page
    ...
    Examples:
      | username                                                | password | BSCstatus | BillCap   | CapAmount | Device_Name   | Username     | Action    |
      | stester1169c70e98-990f-4480-aba3-dfecd3e25601@gmail.com | test123  | Enabled   | CapMyBill | £60       | Random Device | TEST ACCEPTA | enterCode |
