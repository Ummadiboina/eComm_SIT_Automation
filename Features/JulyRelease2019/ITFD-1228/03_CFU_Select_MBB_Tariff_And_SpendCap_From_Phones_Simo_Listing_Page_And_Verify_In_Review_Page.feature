Feature: 03_CFU_Select_MBB_Tariff_And_SpendCap_From_Phones_Simo_Listing_Page_And_Verify_In_Review_Page

  This scenario ensures that when an upgrade user selects 'Sim only Tariff' tab and lands on Simo listing page and
  selects 18 Months MBB tariff then customer should be able to select spend cap and same should be displayed in review
  and confirm page

  @Web
  Scenario Outline: 03_CFU_Select_MBB_Tariff_And_SpendCap_From_Phones_Simo_Listing_Page_And_Verify_In_Review_Page
