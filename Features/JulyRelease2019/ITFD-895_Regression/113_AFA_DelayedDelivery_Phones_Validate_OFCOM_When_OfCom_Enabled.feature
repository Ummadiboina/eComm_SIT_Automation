Feature: 113_AFA_DelayedDelivery_Phones_Validate_OFCOM_When_OfCom_Enabled
  ...
  Scenario Outline: 113_AFA_DelayedDelivery_Phones_Validate_OFCOM_When_OfCom_Enabled
    ...
    Examples:
      ...
      | Huawei P20 Pro Twilight | Refresh | Random    | Insurance | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | DelayedDelivery Phone | Connected  | Phone        | Enabled     | Yes          | 07707003538    | valid      | PAC         | XBA031038   | Yes                 |
