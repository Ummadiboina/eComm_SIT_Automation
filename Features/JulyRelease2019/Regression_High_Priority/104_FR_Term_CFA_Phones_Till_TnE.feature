Feature: 104_FR_Upfront_CFA_Phones_Till_TnE.feature

  @Web
  Scenario Outline: 104_FR_Upfront_CFA_Phones_Till_TnE
    ...
    Examples:
      ...
      | Galaxy S9 | Test Accepta | £39       | 8GB       | Lilac Purple | Test      | Accepta | Me       | Enabled   | Select | Not | Not | Not | Select | Not   | Not   | Not  | Enabled    | No        | Connected  | min     | max  | avg  | No          | No       |
