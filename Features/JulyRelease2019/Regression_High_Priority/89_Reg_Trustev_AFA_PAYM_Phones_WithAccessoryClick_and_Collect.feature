Feature: 89_Reg_Trustev_AFA_PAYM_Phones_WithAccessoryClick_and_Collect
  ...
  Scenario Outline: Trustev PayM Phones Click and collect E2E journey with Accessory in Agent shop
    ...
    Examples:
      ...
      | Galaxy S9 Plus 128GB Midnight Black | Refresh | Enabled   | £20           | Samsung S8 Plus Evo Wallet | TEST      | ACCEPTA | 32          | SL11ER   | TEST ACCEPTA | test123  | test123          | Anything        | Select | Select | Not | Not | Not  | Select | Not   | Select | Me       | Enabled | test123  | test123         | Jkhan          | No        | Connected  | Phone        |
