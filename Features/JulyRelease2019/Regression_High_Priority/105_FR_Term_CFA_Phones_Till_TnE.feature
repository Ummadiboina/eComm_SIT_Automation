Feature: 105_FR_Upfront_CFA_Phones_Till_TnE.feature

  @Web
  Scenario Outline: 105_FR_Upfront_CFA_Phones_Till_TnE
    ...
    Examples:
      ...
      | iPhone XR | Test Accepta | £39       | 8GB       | Black | Test      | Accepta | Me       | Enabled   | Select | Not | Not | Not | Select | Not   | Not   | Not  | Enabled    | No        | Connected  | max     | avg  | avg  | No          | No       |
