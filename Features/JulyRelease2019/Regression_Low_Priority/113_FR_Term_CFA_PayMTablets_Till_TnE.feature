Feature: 113_FR_Upfront_CFA_PayMTablets_Till_TnE.feature
  ...
  Scenario Outline: 113_FR_Upfront_CFA_PayMTablets_Till_TnE
    ...
    Examples:
      ...
      | iPad 9.7 inch 2018 | Test Accepta | £39       | 8GB       | 32GB     | Space Grey | Test      | Accepta | Me       | Enabled   | Select | Not | Not | Not | Select | Not   | Not   | Not  | Enabled    | No        | Connected  | avg     | avg  | min  | No          | No       |
