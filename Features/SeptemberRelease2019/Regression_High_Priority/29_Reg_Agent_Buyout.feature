Feature: 29_Reg_Agent_Buyout
  ...
  Scenario Outline: Successful completion of a BuyOut Journey
    ...
    Examples:
      ...
      | 07521117351 | Apple iPhone 7 Plus 32GB Rose Gold | Random | Enabled   | £15           | Refresh | sittester-545d763e-a693-42d4-b39e-d65dcd7f9bb0@gmail.com | HomeDelivery | Test      | Accepta | Flat 9      | SL11EL   | Test Accepta | test123  | Me       | Not | Not | Select | Not | Select | Select | Select | Select | Enabled | No        | Connected  | No          |