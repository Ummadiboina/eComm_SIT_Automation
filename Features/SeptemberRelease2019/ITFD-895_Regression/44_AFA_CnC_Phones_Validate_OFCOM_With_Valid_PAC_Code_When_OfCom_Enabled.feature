Feature: 44_AFA_CnC_Phones_Validate_OFCOM_With_Valid_PAC_Code_When_OfCom_Enabled
  ...
  Scenario Outline: 44_AFA_CnC_Phones_Validate_OFCOM_With_Valid_PAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | Galaxy Note9 | Refresh | Random    | Insurance | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | AFA     | Connected  | Phone        | Enabled     | Yes          | 07707003808    | valid      | PAC         | XBA746327   | Yes                 |
