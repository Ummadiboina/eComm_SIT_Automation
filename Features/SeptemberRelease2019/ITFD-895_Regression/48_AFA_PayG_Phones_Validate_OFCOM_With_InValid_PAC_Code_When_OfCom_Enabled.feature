Feature: 48_AFA_PayG_Phones_Validate_OFCOM_With_InValid_PAC_Code_When_OfCom_Enabled
  ...
  Scenario Outline: 48_AFA_PayG_Phones_Validate_OFCOM_With_InValid_PAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | Galaxy S8 Plus 64GB Midnight Black | Random  | Disabled  | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | AFA     | Enabled     | Yes          | 07707003811    | XBA337855   | Yes                 | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | Connected  | Phones       | PAC         | HomeDelivery | Invalid    |
