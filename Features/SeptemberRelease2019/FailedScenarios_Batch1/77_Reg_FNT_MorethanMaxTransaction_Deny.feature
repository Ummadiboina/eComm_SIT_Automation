Feature: 77_Reg_FNT_MorethanMaxTransaction_Deny
  ...
  Scenario Outline: FNT CFA PayM Phones Click and collect scenario for More than Max Transaction
    ...
    And land on the pay in full payment page and input <Username> and other details for Click and collect order and click 'Continue on next step'
    ...
    Examples:
      ...
      | iPhone Xs | Midnight Black | 64GB     | TEST      | NINE    | TEST NINE | Me       | Enabled   | DontCapMyBill | Nill      | Select | Not | Not | Not | Select | Not   | Not   | Not  | Enabled    | No        | Connected  | No       | No          |
