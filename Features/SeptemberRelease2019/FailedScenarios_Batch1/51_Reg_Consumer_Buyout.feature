Feature: 51_Reg_Consumer_Buyout
  ...
  Scenario Outline: This scenario ensures that the customer is able to successully Buyout the device
    ...
    Examples:
      ...
      | in00322v_372415@o2.com | Enabled   | CapMyBill | £200      | test123  | iPhone 7 | skip   | TEST ACCEPTA | OTAC | Delivery | Payment | Agreement | Review | TEST ACCEPTA | enterCode | Me       | Not | Not | Select | Not | Not  | Select | Not   | Not  | Enabled    | No        | Connected  | No          | No       |
