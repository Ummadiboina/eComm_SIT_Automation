# Validating Device Highlights below the Product Image
# Tags: optional

Feature: 01_CFA_Device_Highlights_Should_Display_When_Technical_Specification_Available_For_Device


  This Scenario ensures that when the Customer in acquisition journey selects 'PAYM Phone' and lands on
  phone details page then customer should be displayed with Device Highlights below the product image when Technical
  Specification available for a device
