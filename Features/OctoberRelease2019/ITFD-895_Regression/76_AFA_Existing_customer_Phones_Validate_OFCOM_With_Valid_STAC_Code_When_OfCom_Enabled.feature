Feature: 76_AFA_Existing_customer_Phones_Validate_OFCOM_With_Valid_STAC_Code_When_OfCom_Enabled
  ...
  Scenario Outline: 76_AFA_Existing_customer_Phones_Validate_OFCOM_With_Valid_STAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | 07521129162 | iPhone 8 Plus 64GB Space Grey | Refresh | Enabled   | £100          | TEST ACCEPTA | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | Phones  | Connected  | Phone        | Enabled     | Yes          | 07707003848    | valid      | STAC        | 054109XBA   | Yes                 |
