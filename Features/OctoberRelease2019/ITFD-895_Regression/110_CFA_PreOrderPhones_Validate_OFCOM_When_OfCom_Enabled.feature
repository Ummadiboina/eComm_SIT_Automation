Feature: 110_CFA_PreOrderPhones_Validate_OFCOM_When_OfCom_Enabled


  @Web
  Scenario Outline:110_CFA_PreOrderPhones_Validate_OFCOM_When_OfCom_Enabled
    ...
    Examples:
      ...
      | Pixel 3 | Just Black | 128GB    | Pre Order | TEST      | ACCEPTA | TEST ACCEPTA | PreOrder Phone | Enabled     | Yes          | valid      | PAC         | Yes                 | 07707003537    | XBA794587   | Enabled   | CapMyBill | £15       |
