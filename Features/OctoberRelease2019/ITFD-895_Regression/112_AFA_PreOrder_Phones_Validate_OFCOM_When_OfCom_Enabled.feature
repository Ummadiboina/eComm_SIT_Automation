Feature: 112_AFA_PreOrder_Phones_Validate_OFCOM_When_OfCom_Enabled
  ...
  Scenario Outline: 112_AFA_PreOrder_Phones_Validate_OFCOM_When_OfCom_Enabled
    ...
    Examples:
      ...
      | Huawei Mate 20 Pro Black | Refresh | Random    | Insurance | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | PreOrder Phone | Connected  | Phone        | Enabled     | Yes          | 07707003538    | valid      | PAC         | XBA031038   | Yes                 |
