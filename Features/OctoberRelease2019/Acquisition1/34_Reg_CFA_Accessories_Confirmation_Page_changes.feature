Feature: 34_Reg_CFA_Accessories_Confirmation_Page_changes
  ...
  then the customer should be able to see the changes in Confirmation page
    ...
    Examples:
      | Firstname | Surname | Username     | Status   | consumer | B1  | B2  | B3  | B4  | Text | Email | Phone | Post | GDPRstatus | MBBStatus | DeviceType   | KeyEvent |
      | TEST      | ACCEPTA | TEST ACCEPTA | In Stock | Me       | Not | Not | Not | Not | Not  | Not   | Not   | Not  | Enabled    | No        | NonConnected | No       |
