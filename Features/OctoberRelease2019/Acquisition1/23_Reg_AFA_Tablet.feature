Feature: 23_Reg_AFA_Tablet
  ...
  Scenario Outline: Successful completion of a Tablet Journey
    ...
    Examples:
      ...
      | Apple iPad Pro 11 2018 512GB Space Grey | Random  | HomeDelivery | Enabled   | £100          | TEST      | ACCEPTA | TEST ACCEPTA | 18          | SL11UP   | Me       | Select | Select | Select | Not | Select | Select | Select | Select | Enabled | No        | Connected  | Tablet       |
