Feature: 01_AFA_Phone_Premium_Tariff_And_Later_Perk_Without_Accessorries
  ...
  Scenario Outline: 01_AFA_Phone_Premium_Tariff_And_Later_Perk_Without_Accessorries
    ...
    Examples:
      ...
      | iPhone Xs Max 256GB Gold | £35       | 30D        | 60GB      | laterPerk | laterPerk | AFA     | Enabled    | HomeDelivery | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | No        | Connected  | Phone        |
