Feature: 14_AFA_Phone_Mid_Tariff_And_International_Caller_Bolton_Without_Accessorries

  #launch hooks and get browser
  @Web
  Scenario Outline: 14_AFA_Phone_Mid_Tariff_And_International_Caller_Bolton_Without_Accessorries
    ...
    Examples:
      ...
      | Galaxy S10 Plus Prism Black | 30D        | £28       | 20GB      | B:CR7682:International:Caller:Bolton:GBP1 | giftPerk | AFA     | Enabled    | HomeDelivery | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | No        | Connected  | Phone        |
