Feature: 18_AFU_Phone_Premium_Tariff_And_International_Caller_Bolton
  ...
  Scenario Outline: 18_AFU_Phone_Premium_Tariff_And_International_Caller_Bolton
    ...
    Examples:
      ...
      | 07521155211 | iPhone Xs 64GB Space Grey | 30D        | £35       | 60GB      | B:CR7682:Amazon:12M:UnlimitedMusic:FOC | giftPerk | AFU     | Enabled    | HomeDelivery | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Not | Select | Not | Select | Not   | Not   | Not  | Enabled | No        | Connected  | Phone        |
