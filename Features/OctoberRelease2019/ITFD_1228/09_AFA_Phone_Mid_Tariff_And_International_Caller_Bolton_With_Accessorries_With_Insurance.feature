Feature: 09_AFA_Phone_Mid_Tariff_And_International_Caller_Bolton_With_Accessorries_With_Insurance
  ...
  Scenario Outline: 09_AFA_Phone_Mid_Tariff_And_International_Caller_Bolton_With_Accessorries_With_Insurance
    ...
    Examples:
      ...
      | iPhone Xs Max 256GB Gold | Random    | Insurance | 30D        | £23       | 3GB       | B:CR7682:Amazon:12M:UnlimitedMusic:FOC | giftPerk | AFA     | Enabled    | HomeDelivery | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | No        | Connected  | Phone        |
