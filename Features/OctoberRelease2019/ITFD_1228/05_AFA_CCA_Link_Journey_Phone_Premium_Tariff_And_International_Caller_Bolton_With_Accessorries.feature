Feature: 05_AFA_CCA_Link_Journey_Phone_Premium_Tariff_And_International_Caller_Bolton_With_Accessorries
  ...
  Scenario Outline: 05_AFA_CCA_Link_Journey_Phone_Premium_Tariff_And_International_Caller_Bolton_With_Accessorries
    ...
    Examples:
      ...
      | Huawei P30 Pro Aurora | random@test.com | test123  | £35       | 30D        | 1000GB    | B:CR7682:Amazon:12M:UnlimitedMusic:FOC | giftPerk | AFA     | Enabled    | HomeDelivery | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | No        | Connected  | Phone        |
