Feature: 07_AFA_ExistingCust_NewContn_Phone_Mid_Tariff_And_Amazon_6M_PrimeVideo_Perk_With_Insurance
  ...
  Scenario Outline: 07_AFA_ExistingCust_NewContn_Phone_Mid_Tariff_And_Amazon_6M_PrimeVideo_Perk_With_Insurance
    ...
    Examples:
      ...
      | 07521127311 | Galaxy S10 Plus 128GB Prism Blue | Insurance | £31       | 30D        | 40GB      | B:CR7682:Amazon:12M:UnlimitedMusic:FOC | giftPerk | AFA     | Enabled    | HomeDelivery | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | No        | Connected  | Phone        |
