Feature: 15_AFU_Phone_Premium_Tariff_And_Amazon_12M_UnlimitedMusic_Perk
  ...
  Scenario Outline: 15_AFU_Phone_Premium_Tariff_And_Amazon_12M_UnlimitedMusic_Perk
    ...
    Examples:
      ...
      | 07521155211 | iPhone Xs 64GB Space Grey | 30D        | £27       | 30GB      | B:CR7682:Amazon:12M:UnlimitedMusic:FOC | giftPerk | AFU     | Enabled    | HomeDelivery | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | No        | Connected  | Phone        |
