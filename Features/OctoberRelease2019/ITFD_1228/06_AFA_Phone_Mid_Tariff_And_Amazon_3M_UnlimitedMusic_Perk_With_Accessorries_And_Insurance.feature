Feature: 06_AFA_Phone_Mid_Tariff_And_Amazon_3M_UnlimitedMusic_Perk_With_Accessorries_And_Insurance

  #launch hooks and get browser
  @Web
  Scenario Outline: 06_AFA_Phone_Mid_Tariff_And_Amazon_3M_UnlimitedMusic_Perk_With_Accessorries_And_Insurance
    ...
    Examples:
      ...
      | Galaxy S10 Plus Prism White | Random    | Insurance | £60       | 30D        | 5GB       | B:CR7682:Amazon:12M:UnlimitedMusic:FOC | giftPerk | AFA     | Enabled    | HomeDelivery | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | No        | Connected  | Phone        |
