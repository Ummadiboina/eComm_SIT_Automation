Feature: 12_AFA_Phone_Standard_Tariff_And_3M_Cafeyn_Perk_With_Accessorries_And_Insurance

  #launch hooks and get browser
  @Web
  Scenario Outline: 12_AFA_Phone_Standard_Tariff_And_3M_Cafeyn_Perk_With_Accessorries_And_Insurance
