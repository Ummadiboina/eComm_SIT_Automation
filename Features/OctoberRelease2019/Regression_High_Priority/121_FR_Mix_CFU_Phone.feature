Feature: 121_FR_Mix_CFU_Phone.feature
  ...
  Scenario Outline: 121_FR_Mix_CFU_Phone
    ...
    Examples:
      ...
      | inavpte4_072205@o2.com | test123  | Galaxy S10 Plus | min     | min  | min  | enterCode | TEST      | ACCEPTA | TEST ACCEPTA | low        | Disabled  | Monthly data (High to low) | A3 10      | Me       | Select | Not | Not | Not | Not  | Select | Not   | Not  | Enabled    | No        | Connected  | Yes         | No       |
