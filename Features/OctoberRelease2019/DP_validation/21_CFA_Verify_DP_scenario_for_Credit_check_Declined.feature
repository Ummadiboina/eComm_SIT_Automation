Feature: 04_CFA_Verify_DP_E2E_scenario_for_Commercial_PostCode_with_residential_house_number


  @Web
  Scenario Outline:CFA_Verify_DP_E2E_scenario_for_Commercial_PostCode_with_residential_house_number
    ...
    Examples:
      ...
      | iPhone 8 Plus |      |         |sb-iitid433240@personal.example.com | 5PiDsE8/       |   residential  |    312      |   Valid        | TEST      | ACCEPTA | TEST ACCEPTB   | Enabled   | CapMyBill | £15       | Select | Not | Not | Enabled    | Connected  | No          | No       | CFA     | Both   | Enabled  |
