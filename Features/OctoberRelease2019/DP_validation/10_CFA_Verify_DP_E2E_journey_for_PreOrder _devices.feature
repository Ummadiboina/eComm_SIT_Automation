Feature: 10_CFA_Verify_DP_E2E_journey_for_PreOrder _devices


  @Web
  Scenario Outline: CFA_Verify_DP_E2E_journey_for_PreOrder _devices
    ...
    Examples:
      | handset       | color | Capacity | Status     | payPalUser                          | payPalPassword | Firstname | Surname | Username     | BSCstatus | BillCap   | CapAmount | B1     | B2  | B3  | GDPRstatus | DeviceType | PreSelected | KeyEvent | journey | DPFlag | DPStatus |
      | iPhone 8 Plus |       |          | Pre Order  |sb-iitid433240@personal.example.com | 5PiDsE8/       | TEST      | ACCEPTA | TEST ACCEPTA | Enabled   | CapMyBill | £15       | Select | Not | Not | Enabled    | Connected  | No          | No       | CFA     | Both   | Enabled  |
