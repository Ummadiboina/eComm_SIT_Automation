Feature: 18_CFA_Verify_DP_scenario_getting_Error_message_for_Invalid_PostCode


  @Web
  Scenario Outline:18_CFA_Verify_DP_scenario_getting_Error_message_for_Invalid_PostCode
    ...
    Examples:
      ...
      | iPhone 8 Plus |      |         |sb-iitid433240@personal.example.com | 5PiDsE8/       |                |             |   InValid        | TEST      | ACCEPTA | TEST ACCEPTA | Enabled   | CapMyBill | £15       | Select | Not | Not | Enabled    | Connected  | No          | No       | CFA     | Both   | Enabled  |
