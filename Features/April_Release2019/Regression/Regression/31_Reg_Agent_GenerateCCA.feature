Feature: 31_Reg_Agent_GenerateCCA
  ...
  Scenario Outline: Successful completion of a PAY M Acquistion journey by CCA settlement
    ...
    Examples:
      | Device                        | Tariffs | Extras | BSCstatus | BillCapAmount | DeliveryType | Firstname | Surname | Username     | HouseNumber | PostCode | Password | confirmPassword | SecurityAnswer | B1     | B2     | B3     | B4  | Text   | Email  | Phone  | Post   | Consumer | GDPRstatus | GDPRstatus2 | consumer | username                     | password | MBBStatus | DeviceType | DeviceModule | KeyEvent | PreSelected |
      | iPhone 8 Plus 64GB Space Grey | Refresh | Base   | Enabled   | £60           | HomeDelivery | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test123  | test123         | vinudeep       | Select | Select | Select | Not | Select | Select | Select | Select | Me       | Enabled    | Disabled    | Me       | ink_jun8829@stf.ref.o2.co.uk | test123  | No        | Connected  | Phone        | No       | Yes         |
