Feature: 16_AFU_SmiOnly_RetentionBolton_CopyToCustomerBuilder_EmailBasket

  AFU	SmiOnly	- / Simo	Retention Bolton	Copy to customer Builder	email basket

  @Web
  Scenario Outline: 16_AFU_SmiOnly_RetentionBolton_CopyToCustomerBuilder_EmailBasket
