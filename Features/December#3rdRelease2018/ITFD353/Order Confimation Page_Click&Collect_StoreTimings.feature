Feature: Order Confimation Page_Click&Collect_StoreTimings
  ...
  Scenario Outline: Order Confimation Page_Click&Collect_StoreTimings
    ...
    Examples:
      | handset       | color      | Firstname | Surname | Username     | BSCstatus | BillCap   | CapAmount | consumer | B1     | B2     | B3     | KeyEvent | DeviceType | GDPRstatus | PreSelected | Post | status  | MBBStatus | DeviceType |
      | iPhone 8 Plus | Space Grey | TEST      | ACCEPTA | TEST ACCEPTA | Enabled   | CapMyBill | £30       | Me       | Select | Select | Select | No       | Connected  | Enabled    | No          | Not  | Enabled | No        | Connected  |
