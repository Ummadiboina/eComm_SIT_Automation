Feature: CFA_BudgetLed_AvgMonthlyBudget_AvgMonthlydata

  @Web
  Scenario Outline: CFA_BudgetLed_AvgMonthlyBudget_AvgMonthlydata
    ...
    Examples:
      ...
      | iPhone 8 Plus | £39       | 8GB       | Space Grey | avg           | avg         | Test      | Accepta | Someone  | Enabled   | Select | Not | Not | Not | Select | Not   | Not   | Not  | Enabled | No        | Connected  | avg     | min  | avg  | TEST      | ACCEPTA |
