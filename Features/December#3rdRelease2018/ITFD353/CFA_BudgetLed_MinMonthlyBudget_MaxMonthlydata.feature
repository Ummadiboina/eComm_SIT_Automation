Feature: CFA_BudgetLed_MinMonthlyBudget_MaxMonthlydata
  @Web
  Scenario Outline: CFA_BudgetLed_MinMonthlyBudget_MaxMonthlydata
   # Given I am an CFA user and Lands on shop page
    ...
    Examples:
      ...
      | iPhone 8 Plus | £39       | 8GB       | Space Grey | Min           | Max         | Test      | Accepta | Someone  | Enabled   | Select | Not | Not | Not | Select | Not   | Not   | Not  | Enabled | No        | Connected  | avg     | min  | avg  | TEST      | ACCEPTA |
