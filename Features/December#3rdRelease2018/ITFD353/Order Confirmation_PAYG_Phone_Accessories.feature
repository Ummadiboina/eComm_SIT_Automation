Feature: 61_Reg_CS_PayGPhonesHomeDeliveryWithoutAccessory
  ...
  Scenario Outline: CFA PayG Phones Home delivery E2E journey
   ...
   # And Validate consumer GDPR consent section and choose Business preferences <B1> <B2> <B3> with <KeyEvent> for <DeviceType> in delivery page when GDPR is <GDPRstatus> and <PreSelected>
    ...
    Examples:
      | handset       | color      | Firstname | tariff | BSCstatus | Surname | Username     | consumer | B1     | B2     | B3     | KeyEvent | DeviceType | GDPRstatus | PreSelected | Post | status  | MBBStatus | DeviceType |
      | iPhone 8 Plus | Space Grey | TEST      |        | Disabled  | ACCEPTA | TEST ACCEPTA | Me       | Select | Select | Select | No       | Connected  | Enabled    | No          | Not  | Enabled | No        | Connected  |
