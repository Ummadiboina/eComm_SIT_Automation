Feature: 21_Agent_Existing_SIMO_HomeDelivery_GDPR_Enabled_EndUser_MP_Optin_B2_CP_Phone

  #launch hooks and get browser
  @Web
  Scenario Outline: 21_Agent_Existing_SIMO_HomeDelivery_GDPR_Enabled_EndUser_MP_Optin_B2_CP_Phone
    ...
    Examples:
      ...
      | 07568414065 | Simo    | Enabled   | £30           | Me       | Not | Select | Not | Not | Not  | Not   | Select | Not  | Enabled | No        | Connected  | Yes         |