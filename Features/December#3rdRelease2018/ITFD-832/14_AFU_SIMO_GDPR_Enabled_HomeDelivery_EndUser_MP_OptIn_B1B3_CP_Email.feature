Feature: 14_AFU_SIMO_GDPR_Enabled_HomeDelivery_EndUser_MP_OptIn_B1B3_CP_Email

  #launch hooks and get browser
  @Web
  Scenario Outline: 14_AFU_SIMO_GDPR_Enabled_HomeDelivery_EndUser_MP_OptIn_B1B3_CP_Email
    ...
    Examples:
      ...
      | 07568414065 | Simo    | Enabled   | £200          | Me       | Select | Not | Select | Not | Not  | Select | Not   | Not  | Enabled | No        | Connected  | Yes         |