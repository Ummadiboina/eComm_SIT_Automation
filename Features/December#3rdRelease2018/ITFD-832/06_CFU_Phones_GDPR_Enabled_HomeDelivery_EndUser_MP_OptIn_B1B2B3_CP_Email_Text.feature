Feature: 06_CFU_Phones_GDPR_Enabled_HomeDelivery_EndUser_MP_OptIn_B1B2B3_CP_Email_Text

  This Scenario ensures that when the upgrade customer  selects 'PAYM Phone' with Home delivery and placed an order, Verify that  Marketing preference 'B1/B2/B3' and CP 'Email/Text' are selected by default, then the Order consent profile should be created in CMT as expected

  @Web
  Scenario Outline: 06_CFU_Phones_GDPR_Enabled_HomeDelivery_EndUser_MP_OptIn_B1B2B3_CP_Email_Text
    ...
    Examples:
      ...
      | rbmuatlokesh_donotusee3035@stf.ref.o2.co.uk | test123  | 11          | SL11Er   | iPhone 8 Plus | Enabled   | DontCapMyBill | Nill      | TEST ACCEPTA | enterCode | 129.99upfront37.00amonth | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | No        | Connected  | Yes         |
