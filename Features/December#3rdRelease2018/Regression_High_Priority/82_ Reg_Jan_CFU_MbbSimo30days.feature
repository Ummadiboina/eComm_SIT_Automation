Feature: 82_ Reg_Jan_CFU_MbbSimo30days
  ...
  Scenario Outline: CFU_MbbSimo30days
    ...
    Examples:
      ...
      | 30 Days  | in02818o_785853@o2.com | Enabled   | DontCapMyBill | Nill      | test123  | low        | Monthly data (High to low) | TEST ACCEPTA | Me       | Not | Not | Select | Not | Not  | Select | Not   | Not  | Enabled | No        | Connected  | No          |