Feature: 98_Reg_June_CFU_Validate_BasketPage_For_SimoTariff_With_Active_VoucherablePromotions_Available_And_Valid_For_CurrentDate_And_NoUpfrontPaymentPending
  ...
  Scenario Outline: 98_Reg_June_CFU_Validate_Basket_Page_For_Simo_Tariff_With_Active_Voucherable_Promotions_Available_And_Valid_For_Current_Date_And_No_Upfront_Payment_Pending
    ...
    Examples:
      | username                      | tariffAmt | dataValue | promoCode | password | BSCstatus | BillCap       | CapAmount | Username     | consumer | B1  | B2  | B3     | B4  | Text | Email  | Phone | Post | status  | MBBStatus | DeviceType | PreSelected |
      | 16fe38101321@stf.ref.o2.co.uk | £18       | 6GB       | VOUCHER3  | test123  | Enabled   | DontCapMyBill | Nill      | TEST ACCEPTA | Me       | Not | Not | Select | Not | Not  | Select | Not   | Not  | Enabled | No        | Connected  | No          |
