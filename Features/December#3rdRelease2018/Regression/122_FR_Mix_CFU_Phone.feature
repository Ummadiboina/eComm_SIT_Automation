Feature: 122_FR_Mix_CFU_Phone
  ...
  Scenario Outline: 10_1_FR_Mix_CFU_Phone
    ...
    Examples:
      ...
      | rbmuatlokesh_donotusee3017@stf.ref.o2.co.uk | test123  | iPhone 8 Plus | avg     | avg  | avg  | skip   | TEST      | ACCEPTA | TEST ACCEPTA | low        | Disabled  | Monthly data (High to low) | A3 10      | Me       | Select | Not | Not | Not | Not  | Select | Not   | Not  | Enabled | No        | Connected  | min     | min  | min  | No          |
