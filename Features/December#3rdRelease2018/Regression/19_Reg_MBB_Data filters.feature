Feature: 19_Reg_MBB_Data filters
  ...
  Scenario Outline: CFA_MBB_Data filters
    ...
    Examples:
      | Device_Name   | Firstname | Surname | Username     | filtername | sortoption                 | consumer | BSCstatus | BillCap       | CapAmount | B1  | B2  | B3  | B4  | Text | Email | Phone | Post | status  | MBBStatus | DeviceType | PreSelected |
      | Random Device | TEST      | ACCEPTA | TEST ACCEPTA | high       | Monthly data (High to low) | Someone  | Enabled   | DontCapMyBill | Nill      | Not | Not | Not | Not | Not  | Not   | Not   | Not  | Enabled | No        | Connected  | No          |