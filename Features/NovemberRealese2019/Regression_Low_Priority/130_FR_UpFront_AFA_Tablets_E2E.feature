Feature: 130_FR_UpFront_AFA_Tablets_E2E
  ...
  Scenario Outline: Successful completion of a Tablet Journey
    ...
    Examples:
      ...
      | iPad Pro 11 2018 64GB Silver | Refresh | avg     | avg  | avg  | HomeDelivery | Enabled   | £100          | TEST      | ACCEPTA | TEST ACCEPTA | 18          | SL11UP   | Me       | Select | Select | Select | Not | Select | Select | Select | Select | Enabled | No        | Connected  | Tablet       | test123  | test123         | vinudeep       |
