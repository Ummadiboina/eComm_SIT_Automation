Feature: 93_Reg_Trustev_CFA_PayMTabletsHomeDeliveryWithAccessory
  ...
  Scenario Outline: Trustev PayM Tablets Home delivery E2E journey with Accessory
    ...
    Examples:
      ...
      | iPad Pro 12.9 inch 2018 | Space Grey | 128GB    | TEST      | ACCEPTA | TEST ACCEPTA | Me       | Enabled   | CapMyBill | £15       | Not | Not | Select | Not | Not  | Select | Not   | Not  | Enabled    | No        | Connected  | No          | No       |