Feature: 09_CFA_Verify_DP_E2E_journey_for_Click_and_Collect_Now
  ...
  Scenario Outline: CFA_Verify_DP_E2E_journey_for_Click_and_Collect_Now
    ...
    And upon entering Valid details for DP additional deposite
    ...
    Examples:
      ...
      | iPhone 8 Plus | sb-jczne455099@personal.example.com | test1234       | Commercial     |             |   Valid        | TEST     | ACCEPTA |test acceptb | Enabled   | CapMyBill | £15       | Select | Not | Not | Enabled    | Connected  | No          | No       | CFA     | Both   | Enabled  |
