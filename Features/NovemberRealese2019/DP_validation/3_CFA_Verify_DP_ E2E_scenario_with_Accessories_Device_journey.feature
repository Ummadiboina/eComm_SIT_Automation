Feature: 03_CFA_Verify_DP_ E2E_scenario_with_Accessories_Device_journey

  @Web
  Scenario Outline: CFA_Verify_DP_ E2E_scenario_with_Accessories_Device_journey
    ...
    Examples:
      ...
      | iPad Pro 12.9 inch 2018 | sb-iitid433240@personal.example.com | 5PiDsE8/       | TEST      | ACCEPTA | TEST ACCEPTA | Enabled   | CapMyBill | £15       | Select | Not | Not | Enabled    | Connected  | No          | No       | CFA     | Both   | Enabled  |
