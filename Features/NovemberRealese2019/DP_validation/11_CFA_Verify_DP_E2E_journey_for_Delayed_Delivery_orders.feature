Feature: 1_CFA_Phones_Validate_DigitalPaymets_When_DP_Enabled
  ...
  Scenario Outline:1_CFA_Phones_Validate_DigitalPaymets_When_DP_Enabled
    ...
    Examples:
      ...
      | iPhone 8 Plus |       |          |            | sb-iitid433240@personal.example.com  | 5PiDsE8/       | TEST      | ACCEPTA | TEST ACCEPTA | Enabled   | CapMyBill | £15       | Select | Not | Not | Enabled    | Connected  | No          | No       | CFA     | Both   | Enabled  |
