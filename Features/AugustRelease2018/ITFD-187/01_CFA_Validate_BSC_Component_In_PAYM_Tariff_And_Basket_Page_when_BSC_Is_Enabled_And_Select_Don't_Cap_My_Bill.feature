Feature: 01_CFA_Validate_BSC_Component_In_PAYM_Tariff_And_Basket_Page_when_BSC_Is_Enabled_And_Select_Don't_Cap_My_Bill
  ...
  @Web
  Scenario Outline: 01_CFA_Validate_BSC_Component_In_PAYM_Tariff_And_Basket_Page_when_BSC_Is_Enabled_And_Select_Don't_Cap_My_Bill
    ...
    Examples:
      ...
      | 30 Days  | TEST      | ACCEPTA | TEST ACCEPTA | DontCapMyBill | Nill      | Nill         | Enabled   | Me       | Not | Not | Select | Not | Not  | Select | Not   | Select | Enabled | No        | Connected  |
