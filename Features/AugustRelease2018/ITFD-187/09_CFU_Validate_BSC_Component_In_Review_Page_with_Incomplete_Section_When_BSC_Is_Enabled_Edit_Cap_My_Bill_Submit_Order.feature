Feature: 09_CFU_Validate_BSC_Component_In_Review_Page_with_Incomplete_Section_When_BSC_Is_Enabled_Edit_Cap_My_Bill_Submit_Order

  This scenario ensures when customer on SIMO upgrade journey lands on Review & confirm page and edit the BSC selection
  to Cap my bill, then customer should be redirected to next incomplete section and place your order CTA should be disabled until all the sections are not complete

  @Web
  Scenario Outline: 09_CFU_Validate_BSC_Component_In_Review_Page_with_Incomplete_Section_When_BSC_Is_Enabled_Edit_Cap_My_Bill_Submit_Order
    ...
    Examples:
      ...
      | e2ed14411644@stf.ref.co.uk | test123  | CapMyBill | £10       | £15          | Enabled   | Me       | Select | Not | Select | Not | Select | Not   | Not   | Not  | Enabled | No        | Connected  |