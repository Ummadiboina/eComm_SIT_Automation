Feature: 75_Reg_FNT_AFA_PayG_Phones_less_than_50_GBP_ClickAndCollect
  ...
  Scenario Outline: This test scenario ensures that PaynGo order via the web for payment less than 50 GBP where Click and Collect Now
    ...
    Examples:
      | Device                               | Device   | Tariffs | Firstname | Surname | HouseNumber | PostCode | B1     | B2  | B3     | B4  | Text | Email  | Phone  | Post | Consumer | status  | Password | confirmPassword | SecurityAnswer | MBBStatus | DeviceType | DeviceModule |
      | Galaxy Trend 2 Lite Perfect Like New | In stock | 50      | TEST      | ACCEPTA | 4           | sl11er   | Select | Not | Select | Not | Not  | Select | Select | Not  | Me       | Enabled | test123  | test123         | Jkhan          | No        | Connected  | Phone        |
