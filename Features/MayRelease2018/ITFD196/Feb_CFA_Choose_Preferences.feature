Feature: MayGDPR_CFA_Choose_Preferences
  MayGDPR_CFA_Choose_Preferences

  @Web
  Scenario Outline: MayGDPR_CFA_Choose_Preferences
    ...
    Examples:
      ...
      | Apple iPhone 6 | TEST      | ACCEPTA | TEST ACCEPTA |    Me  | Select | Not | Select | Select |Select|Select | Not | Not|