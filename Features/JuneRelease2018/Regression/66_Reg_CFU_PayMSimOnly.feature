Feature: 66_Reg_CFU_PayMSimOnly
  ...
  Scenario Outline: CFU_PhonesSimo30day
    ...
    Examples:
      ...
      | 30 Days  | Configured | 05ap67035292@stf.ref.o2.co.uk | TEST ACCEPTA | test123  | high       | Monthly data (Low to High) | dfdf      | Me       | Select | Not | Select | Not | Not  | Select | Not   | Not  | Enabled | No        | Connected  |