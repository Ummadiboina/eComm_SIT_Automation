Feature: Reg_Trustev_PayMPhonesHomeDeliveryWithAccessory.feature
  ...
  Scenario Outline: Trustev PayM Phones Home delivery E2E journey with Accessory
    ...
    Examples:
      ...
      | Galaxy S9 | TEST      | ACCEPTA | TEST ACCEPTA | Someone  | Not | Not | Not | Not | Not  | Not   | Not   | Not  | Enabled | No        | Connected  |
