Feature: Reg_Trustev_AFA_PAYM_Phones_WithAccessoryClick_and_Collect
  ...
  Scenario Outline: Trustev PayM Phones Click and collect E2E journey with Accessory in Agent shop
    ...
    Examples: 
      | Device | Tariffs | Accessory | Firstname | Surname | Username     | Password | Confirm_Password | Security_Question | Security_Answer |
      | tablet | Random  |           | TEST      | ACCEPTA | TEST ACCEPTA | test123  | test123          | Memorable name    | Anything        |
