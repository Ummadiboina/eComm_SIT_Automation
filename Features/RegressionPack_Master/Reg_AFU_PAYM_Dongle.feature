Feature: Reg_AFU_PAYM_Dongle
  ...
  Scenario Outline: Successful completion of a PAY M dongle Acqusistion Journey
    ...
    Examples: 
      | Device | Tariffs | Extras | DeliveryType | Firstname | Surname | HouseNumber | PostCode | Username     |
      | dongle | Random  | Random | HomeDelivery | Test      | Accepta | Flat 9      | SL11EL   | Test Accepta |
