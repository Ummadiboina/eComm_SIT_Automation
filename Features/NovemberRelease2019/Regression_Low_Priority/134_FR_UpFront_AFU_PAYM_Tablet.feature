Feature: 134_FR_UpFront_AFU_PAYM_Tablet
  ...
  Scenario Outline: Successful completion of a PAY M Tablet Acqusistion Journey
    ...
    Examples:
      ...
      | 07521154638 | Apple iPad Pro 12.9 inch 2018 1TB Space Grey | Refresh | avg     | avg  | min  | Enabled   | £10           | Me       | Select | Not | Select | Not | Not  | Select | Not   | Not  | Enabled | No        | Connected  |