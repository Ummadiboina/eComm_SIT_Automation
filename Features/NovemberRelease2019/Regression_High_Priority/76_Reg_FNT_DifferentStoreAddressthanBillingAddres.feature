Feature: 76_Reg_FNT_DifferentStoreAddressthanBillingAddres
  ...
  Scenario Outline: FNT PayM Different store address than billing address
    ...
    Examples:
      ...
      | iPhone XR | Ocean Blue | 128GB    | TEST      | Enabled   | DontCapMyBill | Nill      | ACCEPTA | TEST ACCEPTA | Me       | Select | Not | Select | Not | Select | Not   | Not   | Select | Enabled    | No        | Connected  | No          | No       |
