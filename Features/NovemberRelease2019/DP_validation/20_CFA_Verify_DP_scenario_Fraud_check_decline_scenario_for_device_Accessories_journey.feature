Feature: 20_CFA_Verify_DP_scenario_Fraud_check_decline_scenario_for_device_Accessories_journey


  @Web
  Scenario Outline: CFA_Verify_DP_scenario_Fraud_check_decline_scenario_for_Device_Accessories_journey , fraud check team set the data
