Feature: 137_Reg_AFA_Phones_Click_And_Collect_Now
  ...
  Scenario Outline: 137_Reg_AFA_Phones_Click_And_Collect_Now
    ...
    Examples:
      ...
      | 5T 128GB Black | Random  | HomeDelivery | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | No        | Connected  | Phone        |
