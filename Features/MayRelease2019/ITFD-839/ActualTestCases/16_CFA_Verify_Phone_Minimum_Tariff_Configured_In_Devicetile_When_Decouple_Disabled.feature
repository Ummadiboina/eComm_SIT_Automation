Feature: 16_CFA_Verify_Phone_Minimum_Tariff_Configured_In_Devicetile_When_Decouple_Disabled
  ...
  @Web
  Scenario Outline:16_CFA_Verify_Phone_Minimum_Tariff_Configured_In_Devicetile_When_Decouple_Disabled
    ...
    Examples:
      ...
      | DuraiArasi | DuraiArasi | Disable              | Shop             | Minimum       | Apple       | Tariff      | iPhone 6  | iPhone 6 32GB Space Grey (Active) | GETCFATariffCTA |
