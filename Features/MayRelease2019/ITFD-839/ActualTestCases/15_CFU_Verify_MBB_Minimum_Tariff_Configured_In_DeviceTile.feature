Feature: 15_CFU_Verify_MBB_Minimum_Tariff_Configured_In_DeviceTile
  ...
  @Web
  Scenario Outline:15_CFU_Verify_MBB_Minimum_Tariff_Configured_In_DeviceTile
    ...
    Examples:
      ...
      | DuraiArasi | DuraiArasi | Enable               | Shop             | Minimum       | Pocket Hotspot | Tariff      | Huawei 4G 2017 | Huawei 4G 2017 (Active) | GETCFUTariffCTA |
