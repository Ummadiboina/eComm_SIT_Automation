Feature: 13_CFU_Verify_Phone_Minimum_Tariff_Configured_In_DeviceTile
  ...
  @Web
  Scenario Outline:13_CFU_Verify_Phone_Minimum_Tariff_Configured_In_DeviceTile
    ...
    Examples:
      ...
      | DuraiArasi | DuraiArasi | Enable               | Shop             | Minimum       | Apple       | Tariff      | iPhone 6  | iPhone 6 32GB Space Grey (Active) | GETCFUTariffCTA |
