Feature: 14_CFU_Verify_Tablet_Minimum_Tariff_Configured_In_DeviceTile

  This scenario ensures that all the CFU tariffs are displayed for the selected brand, model and variant under Tariff
  config page in Drupal and Choose 'Minimum' tariff type and validate the same on Device tile on Tablet listing page

  @Web
  Scenario Outline:14_CFU_Verify_Tablet_Minimum_Tariff_Configured_In_DeviceTile
    ...
    Examples:
      ...
      | DuraiArasi | DuraiArasi | Enable               | Shop             | Minimum       | Apple       | Tariff      | iPad Pro 10.5 inch | iPad Pro 10.5 inch 64GB Silver (Active) | GETCFUTariffCTA |
