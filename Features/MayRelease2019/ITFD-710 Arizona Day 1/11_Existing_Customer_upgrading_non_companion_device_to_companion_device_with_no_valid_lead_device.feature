Feature: 13_Existing_Customer_upgrading_non_companion_device_to_companion_device_with_no_valid_lead_device

  @Web
  Scenario Outline: Existing_Customer_upgrading_non_companion_device_to_companion_device_with_no_valid_lead_device
