Feature: 26_Agent_Existing_Upgrade_Invalid_Lead_Device_To_Valid _Lead_Device_Place_New_Companion

  #launch hooks and get browser
  @Web
  Scenario Outline: Agent_Existing_Upgrade_Invalid_Lead_Device_To_Valid _Lead_Device_Place_New_Companion
