Feature: 5_CFA_PayM_Tablet_SIMO_Validate_OFCOM_PortIn_Section_When_OfCom_Enabled


  @Web
  Scenario Outline: 5_CFA_PayM_Tablet_SIMO_Validate_OFCOM_PortIn_Section_When_OfCom_Enabled
