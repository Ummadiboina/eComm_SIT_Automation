Feature: 52_AFA_Phones_Validate_OFCOM_With_Expired_PAC_Code_When_OfCom_Enabled
  ...
  Scenario Outline: 52_AFA_Phones_Validate_OFCOM_With_Expired_PAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | Huawei P20 Pro Twilight | Refresh | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | AFA     | Enabled     | Yes          | 07412321141    | Expired    | PAC         | XCR075336   | Yes                 |
