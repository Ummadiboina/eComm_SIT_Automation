Feature: 25_AFA_PayG_Tablets_Validate_OFCOM_Section
  ...
  Scenario Outline: 25_AFA_PayG_Tablets_Validate_OFCOM_Section
    ...
    Examples:
      ...
      | iPad Pro 10.5 inch 64GB Space Grey | Random  | Disabled  | £60           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   |                     | Tablet  | Enabled     | Yes          | 07412321       | XCR661826   | test1234 | test1234        | vinudeep       | InComplete |
