Feature: 4_CFA_PayG_MBB_Validate_OFCOM_PortIn_Section_When_OfCom_Enabled


  @Web
  Scenario Outline:4_CFA_PayG_MBB_Validate_OFCOM_PortIn_Section_When_OfCom_Enabled
    ...
    Examples:
      | tariff | Firstname | Surname | Username     | journey | ofComStatus | pacStacCheck | pacStacCode | codeStatus | codeVariant | ofComMobileNum | BSCstatus |
      |        | TEST      | ACCEPTA | TEST ACCEPTA | MBB     | Enabled     | Not          | Nill        | Nill       | Nill        | Nill           | Disabled  |
