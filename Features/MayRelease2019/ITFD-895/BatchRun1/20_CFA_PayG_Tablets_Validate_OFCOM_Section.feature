Feature: 20_CFA_PayG_Tablets_Validate_OFCOM_Section


  @Web
  Scenario Outline:20_CFA_PayG_Tablets_Validate_OFCOM_Section
    ...
    Examples:
      ...
      | iPad Pro 10.5 inch | TEST      | ACCEPTA | 1GB Preloaded | Tablet  | Enabled     | Yes          | XCR661826   | 074123216      |                     | InComplete | Disabled  |
