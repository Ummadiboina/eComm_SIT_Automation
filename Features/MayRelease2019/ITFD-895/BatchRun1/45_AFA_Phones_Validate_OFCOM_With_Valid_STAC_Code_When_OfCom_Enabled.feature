Feature: 45_AFA_Phones_Validate_OFCOM_With_Valid_STAC_Code_When_OfCom_Enabled
  ...
  Scenario Outline: 45_AFA_Phones_Validate_OFCOM_With_Valid_STAC_Code_When_OfCom_Enabled
    ...
    Examples:
      | Device                             | Tariffs | DeliveryType | BSCstatus | BillCapAmount | Firstname | Surname | Username     | HouseNumber | PostCode | Password | confirmPassword | SecurityAnswer | Consumer | B1     | B2     | B3     | B4  | Text   | Email  | Phone | Post | status  | journey | DeviceType | DeviceModule | ofComStatus | pacStacCheck | ofComMobileNum | codeStatus | codeVariant | pacStacCode | pacStackRetainCheck |
      | Galaxy S8 Plus 64GB Midnight Black | Refresh | HomeDelivery | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | AFA     | Connected  | Phone        | Enabled     | Yes          | 07412321773    | valid      | STAC        | 701889XCR   | Yes                 |
