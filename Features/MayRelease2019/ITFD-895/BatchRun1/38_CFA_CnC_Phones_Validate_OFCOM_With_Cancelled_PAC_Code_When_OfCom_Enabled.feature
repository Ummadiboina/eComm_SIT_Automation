Feature: 38_CFA_CnC_Phones_Validate_OFCOM_With_Cancelled_PAC_Code_When_OfCom_Enabled


  @Web
  Scenario Outline:38_CFA_CnC_Phones_Validate_OFCOM_With_Cancelled_PAC_Code_When_OfCom_Enabled
