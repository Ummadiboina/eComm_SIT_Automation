Feature: 34_CFA_Tablets_Validate_OFCOM_With_InValid_PAC_Code_When_OfCom_Enabled


  @Web
  Scenario Outline:34_CFA_Tablets_Validate_OFCOM_With_InValid_PAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | iPad Pro 10.5 inch | TEST      | ACCEPTA | TEST ACCEPTA | Tablet  | Enabled     | Yes          | Invalid    | PAC         | Yes                 | 07123456789    | XDF543253   | Enabled   | CapMyBill | £15       |
