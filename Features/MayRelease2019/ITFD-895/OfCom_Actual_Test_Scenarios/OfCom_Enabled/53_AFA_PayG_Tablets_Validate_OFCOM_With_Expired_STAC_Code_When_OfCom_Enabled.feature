Feature: 53_AFA_PayG_Tablets_Validate_OFCOM_With_Expired_STAC_Code_When_OfCom_Enabled

  #launch hooks and get browser
  @Web
  Scenario Outline: 53_AFA_PayG_Tablets_Validate_OFCOM_With_Expired_STAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | iPad Pro 10.5 inch 256GB Space Grey | Refresh | Disabled  | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | AFA     | Enabled     | Yes          | 07412321621    | XCR66182    | Yes                 | test1234        | test1234 | vinudeep       | Expired    | STAC        |
