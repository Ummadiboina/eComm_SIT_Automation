Feature: 71_AFU_Generate_CCA_Link_For_MBB_And_Validate_OFCOM_PortIn_Section_When_OfCom_Enabled

  #launch hooks and get browser
  @Web
  Scenario Outline: 71_AFU_Generate_CCA_Link_For_MBB_And_Validate_OFCOM_PortIn_Section_When_OfCom_Enabled
