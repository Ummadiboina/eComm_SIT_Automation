Feature: 63_AFA_FitnessTracker_Validate_OFCOM_With_Archived_STAC_Code_When_OfCom_Enabled

  @Web
  Scenario Outline: 63_AFA_FitnessTracker_Validate_OFCOM_With_Archived_STAC_Code_When_OfCom_Enabled
