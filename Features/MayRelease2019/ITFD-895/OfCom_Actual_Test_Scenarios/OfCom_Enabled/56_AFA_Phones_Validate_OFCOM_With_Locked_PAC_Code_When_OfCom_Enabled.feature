Feature: 56_AFA_Phones_Validate_OFCOM_With_Locked_PAC_Code_When_OfCom_Enabled
  ...
  Scenario Outline: 56_AFA_Phones_Validate_OFCOM_With_Locked_PAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | iPhone 8 Plus 64GB Space Grey | Refresh | Enabled   | £60           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | AFA     | Enabled     | Yes          | 07123456789    | Locked     | PAC         |             | Yes                 |
