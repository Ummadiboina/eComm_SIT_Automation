Feature: 56_AFA_Phones_Validate_OFCOM_With_Locked_PAC_Code_When_OfCom_Enabled

  #launch hooks and get browser
  @Web
  Scenario Outline: 56_AFA_Phones_Validate_OFCOM_With_Locked_PAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | iPhone 8 Plus 64GB Space Grey | Refresh | Enabled   | £60           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | AFA     | Enabled     | Yes          | 07412321616    | Locked     | PAC         | XCR010071   | Yes                 |
