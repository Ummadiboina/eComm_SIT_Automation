Feature: 15_AFA_PayM_SIMO_Validate_OFCOM_PortIn_Section_When_OfCom_Enabled
  ...
  Scenario Outline: 15_AFA_PayM_SIMO_Validate_OFCOM_PortIn_Section_When_OfCom_Enabled
    ...
    Examples:
      ...
      | Standard / Simo | HomeDelivery | Enabled   | £40           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | SIMO    | Connected  | Phone        | Enabled     | Not          | Nill           | Nill       | Nill        |
