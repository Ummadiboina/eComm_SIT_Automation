Feature: 69_AFU_Generate_CCA_Link_For_Phones_And_Validate_OFCOM_PortIn_Section_When_OfCom_Enabled
  ...
  Scenario Outline: 69_AFU_Generate_CCA_Link_For_Phones_And_Validate_OFCOM_PortIn_Section_When_OfCom_Enabled
    ...
    Examples:
      ...
      | 07521139865 | Galaxy S9 Plus 128GB Midnight Black | Refresh | Enabled   | £200          | dono40443969@stf.ref.o2.co.uk | TEST ACCEPTA | HomeDelivery | TEST      | ACCEPTA | TEST ACCEPTA | Flat 6      | SL11EL   | test123  | Me       | Not | Select | Not | Not | Not  | Select | Not   | Not  | Enabled | No        | Connected  | No          | Enabled     | AFU     |
