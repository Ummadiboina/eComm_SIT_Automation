Feature: 42_CFA_Phones_Validate_OFCOM_With_Archived_PAC_Code_When_OfCom_Enabled


  @Web
  Scenario Outline:42_CFA_Phones_Validate_OFCOM_With_Archived_PAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | Galaxy S9 | TEST      | ACCEPTA | Phone   | Enabled     | Yes          | Archived   | PAC         | Yes                 | 07441231111    | XCR716189   | Enabled   | CapMyBill | £15       |
