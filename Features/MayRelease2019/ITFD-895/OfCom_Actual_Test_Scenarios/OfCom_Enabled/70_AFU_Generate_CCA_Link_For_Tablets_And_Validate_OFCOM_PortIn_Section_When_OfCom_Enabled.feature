Feature: 70_AFU_Generate_CCA_Link_For_Tablets_And_Validate_OFCOM_PortIn_Section_When_OfCom_Enabled
  ...
  Scenario Outline: 70_AFU_Generate_CCA_Link_For_Tablets_And_Validate_OFCOM_PortIn_Section_When_OfCom_Enabled
    ...
    Examples:
      ...
      | 07521138178 | iPad Pro 10.5 inch 256GB Space Grey | Refresh | Enabled   | £100          | dont56640665@stf.ref.o2.co.uk | TEST ACCEPTA | HomeDelivery | TEST      | ACCEPTA | TEST ACCEPTA | Flat 6      | SL11EL   | test123  | Me       | Not | Select | Not | Not | Not  | Select | Not   | Not  | Enabled | No        | Connected  | No          | Enabled     | AFU     |
