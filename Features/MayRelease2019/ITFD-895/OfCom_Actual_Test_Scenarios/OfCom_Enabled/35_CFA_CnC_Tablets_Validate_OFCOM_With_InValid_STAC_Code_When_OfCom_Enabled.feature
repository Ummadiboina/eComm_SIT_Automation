Feature: 35_CFA_CnC_Tablets_Validate_OFCOM_With_InValid_STAC_Code_When_OfCom_Enabled


  @Web
  Scenario Outline:35_CFA_CnC_Tablets_Validate_OFCOM_With_InValid_STAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | iPad Pro 10.5 inch | TEST      | ACCEPTA | TEST ACCEPTA | Tablet  | Enabled     | Yes          | Invalid    | STAC        | Yes                 | 07123456789    | XDF543253   | Enabled   | CapMyBill | £15       |
