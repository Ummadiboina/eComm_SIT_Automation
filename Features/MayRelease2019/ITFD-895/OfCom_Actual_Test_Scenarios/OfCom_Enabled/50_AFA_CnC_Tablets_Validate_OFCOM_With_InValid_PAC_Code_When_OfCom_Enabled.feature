Feature: 50_AFA_CnC_Tablets_Validate_OFCOM_With_InValid_PAC_Code_When_OfCom_Enabled

  #launch hooks and get browser
  @Web
  Scenario Outline: 50_AFA_CnC_Tablets_Validate_OFCOM_With_InValid_PAC_Code_When_OfCom_Enabled
    ...
    Examples:
      ...
      | iPad Pro 10.5 inch 256GB Space Grey | Refresh | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | AFA     | Connected  | Tablet       | Enabled     | Yes          | 07123456789    | Invalid    | PAC         |             | Yes                 |
