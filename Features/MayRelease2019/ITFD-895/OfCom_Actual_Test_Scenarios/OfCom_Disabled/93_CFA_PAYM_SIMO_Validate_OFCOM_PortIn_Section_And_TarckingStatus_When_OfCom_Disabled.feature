Feature: 93_CFA_PAYM_SIMO_Validate_OFCOM_PortIn_Section_And_TarckingStatus_When_OfCom_Disabled
  ...
  Scenario Outline: 93_CFA_PAYM_SIMO_Validate_OFCOM_PortIn_Section_And_TarckingStatus_When_OfCom_Disabled
    ...
    Examples:
      | Contract  | postcode | HouseNumber | Firstname | Surname | Username     | BSCstatus | BillCap   | CapAmount | journey | ofComStatus | pacStacCheck | codeStatus | codeVariant | ofComMobileNum |
      | 12 Months | SL33FP   |             | TEST      | ACCEPTA | TEST ACCEPTA | Enabled   | CapMyBill | £0        | SIMO    | Disabled    | Not          | Nill       | Nill        | Nill           |
