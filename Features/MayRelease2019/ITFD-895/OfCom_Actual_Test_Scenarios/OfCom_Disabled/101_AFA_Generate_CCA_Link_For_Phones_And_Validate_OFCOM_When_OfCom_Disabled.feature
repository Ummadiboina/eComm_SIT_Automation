Feature: 101_AFA_Generate_CCA_Link_For_Phones_And_Validate_OFCOM_When_OfCom_Disabled

  #launch hooks and get browser
  @Web
  Scenario Outline: 101_AFA_Generate_CCA_Link_For_Phones_And_Validate_OFCOM_When_OfCom_Disabled
