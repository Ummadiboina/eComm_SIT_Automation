Feature: 96_CFA_PAYG_MBB_Validate_OFCOM_PortIn_Section_And_TarckingStatus_When_OfCom_Disabled
  ...
  Scenario Outline:96_CFA_PAYG_MBB_Validate_OFCOM_PortIn_Section_And_TarckingStatus_When_OfCom_Disabled
    ...
    Examples:
      | tariff | Firstname | Surname | Username     | journey | ofComStatus | pacStacCheck | codeStatus | codeVariant | ofComMobileNum | BSCstatus | pacStacCode |
      |        | TEST      | ACCEPTA | TEST ACCEPTA | MBB     | Disabled    | Not          | Nill       | Nill        | Nill           | Disabled  | Nill        |
