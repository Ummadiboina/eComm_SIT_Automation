Feature: 95_CFA_PAYM_MBB_Validate_OFCOM_PortIn_Section_And_TarckingStatus_When_OfCom_Disabled
  ...
  Scenario Outline:95_CFA_PAYM_MBB_Validate_OFCOM_PortIn_Section_And_TarckingStatus_When_OfCom_Disabled
    ...
    Examples:
      | Device_Name   | Firstname | Surname | Username     | journey | ofComStatus | pacStacCheck | codeStatus | codeVariant | ofComMobileNum | BSCstatus | BillCap       | CapAmount | pacStacCode |
      | Random Device | TEST      | ACCEPTA | TEST ACCEPTA | MBB     | Disabled    | Not          | Nill       | Nill        | Nill           | Enabled   | DontCapMyBill | Nill      | Nill        |
