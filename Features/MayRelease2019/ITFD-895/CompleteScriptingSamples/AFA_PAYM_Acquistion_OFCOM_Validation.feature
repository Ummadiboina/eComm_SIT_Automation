Feature: AFA_PAYM_Acquistion_OFCOM_Validation
  ...
  Scenario Outline: Successful completion of a PAY M Acquistion journey
    ...
    Examples:
      ...
      | iPhone 8 Plus 64GB Space Grey | Refresh | HomeDelivery | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | AFA     | Connected  | Phone        | Enabled     | Yes          | Yes                 | 07123456789    | 123456JKKhan | valid      | PAC         |
