Feature: 03_CFU_editPlan_RecommendedPanel.feature

  This Scenario is to ensure that edit the plan/tariff from the recommended section/pannel added to the basket

  @Web
  Scenario Outline: 03_CFU_editPlan_RecommendedPanel
