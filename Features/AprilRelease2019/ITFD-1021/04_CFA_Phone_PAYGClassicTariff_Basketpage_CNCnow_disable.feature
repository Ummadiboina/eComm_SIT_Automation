Feature: 04_CFA_Phone_PAYG_ClassicTariff_Basketpage_CNCnow_disable
  ...
  @Web
  Scenario Outline: CFA PayG Phones_ClassicTariff_Basket page CNCnow_disable
    ...
    #
    Then Verify that the error <string> is displayed in the basket
