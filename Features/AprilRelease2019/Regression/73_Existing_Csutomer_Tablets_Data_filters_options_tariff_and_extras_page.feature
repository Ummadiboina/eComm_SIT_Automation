Feature: 73_Existing_Csutomer_Tablets_Data_filters_options_tariff_and_extras_page
  ...
  Scenario Outline: Existing_Customer_Tablets_Data_filters_options_tariff_and_extras_page
    ...
    Examples:
      | tabletname | color     | capacity | filtername | BSCstatus | BillCap   | CapAmount | sortoption                 | username                                    | password | Username     | consumer | B1  | B2  | B3     | B4  | GDPRstatus | MBBStatus | DeviceType | PreSelected | KeyEvent |
      | A3 10      | Rose Gold | 32GB     | low        | Enabled   | CapMyBill | £60       | Monthly data (Low to High) | rbmuatlokesh_donotusee2512@stf.ref.o2.co.uk | test123  | TEST ACCEPTA | Me       | Not | Not | Select | Not | Enabled    | No        | Connected  | No          | No       |
