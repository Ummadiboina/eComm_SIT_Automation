Feature: 17_Reg_CFU_Tablet_CnC_changes_on_Delivery_page_Order_placement
  ...
  Scenario Outline: CFU_Tablet_CnC_changes_on_Delivery_page_Order_placement
    ...
    Examples:
      | username                     | password | Firstname | Surname | BSCstatus | BillCap   | CapAmount | Tablet             | color      | Capacity | Username     | Action    | tariff | consumer | B1     | B2  | B3  | B4  | GDPRstatus | MBBStatus | DeviceType | PreSelected | KeyEvent |
      | ink_jun6562@stf.ref.o2.co.uk | test123  | Test      | Accepta | Enabled   | CapMyBill | £30       | iPad 9.7 inch 2018 | Space Grey | 32GB     | TEST ACCEPTA | enterCode |        | Me       | Select | Not | Not | Not | Enabled    | No        | Connected  | No          | No       |
