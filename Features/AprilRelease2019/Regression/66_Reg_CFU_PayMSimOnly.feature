Feature: 66_Reg_CFU_PayMSimOnly
  ...
  Scenario Outline: CFU_PhonesSimo30day
    ...
    Examples:
      | Contract | GiftBlock  | username                      | BSCstatus | BillCap   | CapAmount | Username     | password | filtername | sortoption                 | consumer | B1     | B2  | B3     | B4  | GDPRstatus | MBBStatus | DeviceType | PreSelected | KeyEvent |
      | 30 Days  | Configured | 02ma49092549@stf.ref.o2.co.uk | Enabled   | CapMyBill | £30       | TEST ACCEPTA | test123  | high       | Monthly data (Low to High) | Me       | Select | Not | Select | Not | Enabled    | No        | Connected  | No          | No       |