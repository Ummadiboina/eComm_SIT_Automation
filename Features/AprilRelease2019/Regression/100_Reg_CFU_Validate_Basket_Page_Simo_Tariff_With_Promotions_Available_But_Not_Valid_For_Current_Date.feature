Feature: 100_Reg_CFU_Validate_Basket_Page_Simo_Tariff_With_Promotions_Available_But_Not_Valid_For_Current_Date
  ...
  Scenario Outline: 100_Reg_CFU_Validate_Basket_Page_Simo_Tariff_With_Promotions_Available_But_Not_Valid_For_Current_Date
    ...
    Examples:
      | username                      | tariffAmt | dataValue | promoCode | password | Username     | BSCstatus | BillCap   | CapAmount | consumer | B1     | B2  | B3     | B4  | GDPRstatus | MBBStatus | DeviceType | PreSelected | KeyEvent |
      | 16fe87427757@stf.ref.o2.co.uk | £15       | 5GB       | promoCode | test123  | TEST ACCEPTA | Enabled   | CapMyBill | £30       | Me       | Select | Not | Select | Not | Enabled    | No        | Connected  | No          | No       |