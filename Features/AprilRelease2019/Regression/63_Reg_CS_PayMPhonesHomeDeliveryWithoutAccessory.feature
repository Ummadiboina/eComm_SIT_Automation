Feature: 63_Reg_CS_PayMPhonesHomeDeliveryWithoutAccessory
  ...
  Scenario Outline: CFA PayM Phones Home delivery E2E journey without accessory
    ...
    Examples:
      ...
      | iPhone 8 Plus | Space Grey | 64GB     | Enabled   | CapMyBill | DontCapMyBillLink | TEST      | ACCEPTA | TEST ACCEPTA | Me       | Not | Select | Not | Not | Not  | Select | Not   | Not  | Enabled    | No        | Connected  | No          | No       |
