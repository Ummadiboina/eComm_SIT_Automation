Feature: 11_AFU_MBB_Refresh_RetentionBolton_SharedBasket

  AFU	MBB	Refresh	Retention Bolton		Shared basket

  @Web
  Scenario Outline: 11_AFU_MBB_Refresh_RetentionBolton_SharedBasket
