Feature: 15_AFU_SmiOnly_RetentionBolton_Shared basket

  AFU	SmiOnly	- / Simo	Retention Bolton		Shared basket

  @Web
  Scenario Outline: 15_AFU_SmiOnly_RetentionBolton_Shared basket
