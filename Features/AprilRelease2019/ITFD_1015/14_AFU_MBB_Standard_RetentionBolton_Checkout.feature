Feature: 14_AFU_MBB_Standard_RetentionBolton_Checkout

  AFU	MBB	Standard	Retention Bolton Checkout

  @Web
  Scenario Outline: 14_AFU_MBB_Standard_RetentionBolton_Checkout
