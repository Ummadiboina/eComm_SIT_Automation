Feature: 2_AFU_Phone_Refresh_RetentionBolton_Discount_SharedBasket
  ...
  Scenario Outline: 2_AFU_Phone_Refresh_RetentionBolton_Discount_SharedBasket
    ...
    Examples:
      ...
      | 07568417407 | Huawei P Smart 2019 Black | 60GB 30d | Enabled   | £200          | Me       | Select | Not | Select | Not | Not  | Select | Not   | Not  | Enabled | No        | Connected  | No          | yes             | 15se92529299@stf.ref.o2.co.uk | test123  |