Feature:
  8_AFU_Tablet_Refresh_RetentionBolton_Discount_SharedBasket


  AFU	Tablet	Refresh	Retention Bolton	Device/Tariff Discount	Shared basket

  @Web
  Scenario Outline: 8_AFU_Tablet_Refresh_RetentionBolton_Discount_SharedBasket
