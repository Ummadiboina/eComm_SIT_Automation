Feature: 10_AFU_Tablet_Standard_RetentionBolton_Checkout

  AFU	Tablet	Standard	Retention Bolton		Checkout

  @Web
  Scenario Outline: 10_AFU_Tablet_Standard_RetentionBolton_Checkout
    ...
    Examples:
      ...
      | 07521121757 | Samsung Galaxy Tab A 10.5 | - / Standard | Enabled   | £5            | Me       | Select | Not | Not | Not | Not  | Select | Not   | Select | Enabled | No        | Connected  | No          | yes             |