Feature: 13_AFU_MBB_Refresh_RetentionBolton_CopyToCustomerBuilder_EmailBasket

  AFU	MBB	Refresh	Retention Bolton	Copy to customer Builder	email basket

  @Web
  Scenario Outline: 13_AFU_MBB_Refresh_RetentionBolton_CopyToCustomerBuilder_EmailBasket
    ...
    Examples:
      ...
      | 07568417407 | Huawei 4g dongle | Refresh | Enabled   | £200          | Me       | Select | Not | Select | Not | Not  | Select | Not   | Not  | Enabled | No        | Connected  | No          | yes             | 15se92529299@stf.ref.o2.co.uk | test123  |