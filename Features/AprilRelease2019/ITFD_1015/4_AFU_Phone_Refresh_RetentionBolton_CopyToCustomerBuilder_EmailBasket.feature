Feature: 4_AFU_Phone_Refresh_RetentionBolton_CopyToCustomerBuilder_EmailBasket

  AFU	Phone	Refresh	Retention Bolton	Copy to customer Builder	email basket

  @Web
  Scenario Outline: 4_AFU_Phone_Refresh_RetentionBolton_CopyToCustomerBuilder_EmailBasket
