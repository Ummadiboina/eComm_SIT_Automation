Feature: 12_AFU_MBB_Refresh_RetentionBolton_Discount_SharedBasket
  ...
  Scenario Outline: 12_AFU_MBB_Refresh_RetentionBolton_Discount_SharedBasket
    ...
    Examples:
      ...
      | 07568417407 | Galaxy S9 64GB Midnight Black | Refresh | Enabled   | £200          | Me       | Select | Not | Select | Not | Not  | Select | Not   | Not  | Enabled | No        | Connected  | No          | yes             | 15se92529299@stf.ref.o2.co.uk | test123  |