Feature:02_CFA_Simo_PayM_18_months_contract_option_should_display_under_Phone_Tablet_MBB_Tab
  ...
  @Web
  Scenario Outline:02_CFA_Simo_PayM_18_months_contract_option_should_display_under_Phone_Tablet_MBB_Tab
