Feature:19_CFU_PayM_Simo_Unlimited_data_displayed_up_to_confirmation_page_from_MBB_Tab

  This Scenario ensures that when the Customer in Phone SIMO acquisition journey selects 'Pay Monthly Sims'and lands on
  'Pay Monthly sim deals' and verify Unlimited data is displayed up to confirmation page from MBB Tab

  @Web
  Scenario Outline:19_CFU_PayM_Simo_Unlimited_data_displayed_up_to_confirmation_page_from_MBB_Tab
