Feature:18_CFU_PayM_Simo_Unlimited_data_text_displayed_up_to_confirmation_page_from_Tablet_Tab

  This Scenario ensures that when the Customer in SIMO acquisition journey selects 'Pay Monthly Sims'and lands on
  'Pay Monthly sim deals' and verify Unlimited data is displayed up to confirmation page from Tablet Tab

  @Web
  Scenario Outline:18_CFU_PayM_Simo_Unlimited_data_text_displayed_up_to_confirmation_page_from_Tablet_Tab
