Feature: 14_CFU_Simo_PayM_18months_contarct_option_should_display_upto_confirmation page_from_Tablet_Tab

  This scenario ensures that when  a customer in an upgrade journey and selects 'Pay Monthly Sims'and lands on
  'Pay Monthly sim deals' and verify 18 months contract text is should be displayed upto confirmation page
  under Tablet tab

  @Web
  Scenario Outline: 14_CFU_Simo_PayM_18months_contarct_option_should_display_upto_confirmation page_from_Tablet_Tab
