Feature:04_CFA_Simo_PayM_18_months_contract_text_should_display_up_to_confirmation_page_under_Phone_Tab

  This Scenario ensures that when the Customer in SIMO acquisition journey selects 'Pay Monthly Sims'and lands on
  'Pay Monthly sim deals' and verify 18 months contract text is displaying up to confirmation page from Phone Tab


  @Web
  Scenario Outline:04_CFA_Simo_PayM_18_months_contract_text_should_display_up_to_confirmation_page_under_Phone_Tab
