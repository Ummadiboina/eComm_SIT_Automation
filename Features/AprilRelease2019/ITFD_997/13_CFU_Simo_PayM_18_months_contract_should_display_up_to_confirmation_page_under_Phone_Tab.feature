Feature: 13_CFU_Simo_PayM_18months_contarct_option_should_display_upto_confirmation page_from_Phone_Tab
  ...
  Scenario Outline:13_CFU_Simo_PayM_18months_contarct_option_should_display_upto_confirmation page_from_Phone_Tab
