Feature:09_CFA_PayM_Simo_Unlimited_data_is_displayed_up_to_confirmation_page_from_Tablet_Tab

  This Scenario ensures that when the Customer in SIMO acquisition journey selects 'Pay Monthly Sims'and lands on
  'Pay Monthly sim deals' and verify Unlimited data is displayed under recommended tariff up to confirmation page from
  Tablet Tab

  @Web
  Scenario Outline:09_CFA_PayM_Simo_Unlimited_data_is_displayed_up_to_confirmation_page_from_Tablet_Tab
