Feature: 50_CFU_Tablets_Data_filters_options_tariff_and_extras_page_Order_placement
  ...
  then the customer should be able to see  'Data filter' button next to sort drop-down for PayM tariffs
    ...
    Examples:
      ...
      | iPad Pro 10.5 inch | skip   | Space Grey | 512GB    | ACCEPTA | Enabled   | CapMyBill | £100      | TEST ACCEPTA | high       | Monthly data (Low to High) | ty@ji.com | test123  | Me       | Not | Not | Select | Not | Not  | Select | Not   | Not  | Enabled    | No        | Connected  | No          | No       |
