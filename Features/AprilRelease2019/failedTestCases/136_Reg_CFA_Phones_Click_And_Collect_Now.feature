Feature: 136_Reg_CFA_Phones_Click_And_Collect_Now
  ...
  Scenario Outline: 136_Reg_CFA_Phones_Click_And_Collect_Now
    ...
    Examples:
      ...
      | Huawei P20 Pro Black | TEST ACCEPTA | Test      | Accepta | Lilac Purple | Me       | Enabled   | CapMyBill | £0        | Select | Select | Not | Not | Select | Select | Select | Select | Enabled    | No        | Connected  | No          | No       |