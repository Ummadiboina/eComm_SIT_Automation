Feature: Validating uPFront cost sort Order and filtering tariffs based on upFront cost

  Drupal_ECOMC-6077: Validating uPFront cost sort Order and filtering tariffs based on upFront cost

  @Web
  Scenario Outline:Validating uPFront cost sort Order and filtering tariffs based on upFront cost
    ...
    Examples:
      ...
      | DuraiArasi | DuraiArasi | Shop         | Apple       | Tariff      | iPad Pro 10.5 inch | iPad Pro 10.5 inch 64GB Silver (Active) | GETCFATariffCTA | Enable         | upFront      | upFrontFilter |
