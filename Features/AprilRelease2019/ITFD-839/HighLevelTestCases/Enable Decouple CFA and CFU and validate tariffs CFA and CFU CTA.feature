Feature: Enable Decouple CFA and CFU and validate tariffs CFA and CFU CTA

  Drupal ECOMC-6076:Enable Decouple CFA and CFU and validate tariffs CFA and CFU CTA

  @Web
  Scenario Outline:Enable Decouple CFA and CFU and validate tariffs CFA and CFU CTA
    ...
    Examples:
      ...
      | DuraiArasi | DuraiArasi | Configuration | Enable               | O2General     | Shop             | Apple       | Tariff      | iPad Pro 10.5 inch | iPad Pro 10.5 inch 64GB Silver (Active) | GETCFATariffCTA |
