Feature: 18_CFA_Verify_MBB_Minimum_Tariff_Configured_In_DeviceTile_When_Decouple_Disabled
  ...
  @Web
  Scenario Outline:18_CFA_Verify_MBB_Minimum_Tariff_Configured_In_DeviceTile_When_Decouple_Disabled
    ...
    Examples:
      ...
      | DuraiArasi | DuraiArasi | Disable              | Shop             | Minimum       | Pocket Hotspot | Tariff      | Huawei 4G 2017 | Huawei 4G 2017 (Active) | GETCFATariffCTA |
