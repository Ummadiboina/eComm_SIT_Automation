Feature: 20_Validating_And_Applying_upFront_Sort_Order_For_CFU_Tariffs
  ...
  @Web
  Scenario Outline:20_Validating_And_Applying_upFront_Sort_Order_For_CFU_Tariffs
    ...
    Examples:
      ...
      | DuraiArasi | DuraiArasi | Shop         | Apple       | Tariff      | iPad Pro 10.5 inch | iPad Pro 10.5 inch 64GB Silver (Active) | GETCFUTariffCTA | Enable         | upFront      |
