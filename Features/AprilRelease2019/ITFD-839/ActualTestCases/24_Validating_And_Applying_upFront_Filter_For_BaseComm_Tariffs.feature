Feature: 24_Validating_And_Applying_upFront_Filter_For_BaseComm_Tariffs
  ...
  @Web
  Scenario Outline:24_Validating_And_Applying_upFront_Filter_For_BaseComm_Tariffs
    ...
    Examples:
      ...
      | DuraiArasi | DuraiArasi | Shop         | Apple       | Tariff      | iPad Pro 10.5 inch | iPad Pro 10.5 inch 64GB Silver (Active) | GETBaseCommsTariffCTA | Enable         | data         | upFrontFilter |
