Feature: 02_CFA_Verify_Tablet_Recommended_Tariff_Configured_In_PDAndTnEPage_When_Decouple_Disabled
  ...
  @Web
  Scenario Outline:02_CFA_Verify_Tablet_Recommended_Tariff_Configured_In_PDAndTnEPage_When_Decouple_Disabled
    ...
    Examples:
      ...
      | DuraiArasi | DuraiArasi | Disable              | Shop             | Recommended   | Apple       | Tariff      | iPad Pro 10.5 inch | iPad Pro 10.5 inch 64GB Silver (Active) | GETCFATariffCTA |
