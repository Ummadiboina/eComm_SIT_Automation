Feature: 09_CFA_Verify_MBB_Recommended_Tariff_Configured_In_PDAndTnEPage_When_Decouple_Disabled
  ...
  @Web
  Scenario Outline:09_CFA_Verify_MBB_Recommended_Tariff_Configured_In_PDAndTnEPage_When_Decouple_Disabled
    ...
    Examples:
      ...
      | DuraiArasi | DuraiArasi | Disable              | Shop             | Recommended   | Pocket Hotspot | Tariff      | Huawei 4G 2017 | Huawei 4G 2017 (Active) | GETCFATariffCTA |
