Feature: 17_CFA_Verify_Tablet_Minimum_Tariff_Configured_In_DeviceTile_When_Decouple_Disabled
  ...
  @Web
  Scenario Outline:17_CFA_Verify_Tablet_Minimum_Tariff_Configured_In_DeviceTile_When_Decouple_Disabled
    ...
    Examples:
      ...
      | DuraiArasi | DuraiArasi | Disable              | Shop             | Minimum       | Apple       | Tariff      | iPad Pro 10.5 inch | iPad Pro 10.5 inch 64GB Silver (Active) | GETCFATariffCTA |
