Feature: 05_CFU_Verify_Tablet_Recommended_Tariff_Configured_In_PDAndTnEPage
  ...
  @Web
  Scenario Outline:05_CFU_Verify_Tablet_Recommended_Tariff_Configured_In_PDAndTnEPage
    ...
    Examples:
      ...
      | DuraiArasi | DuraiArasi | Enable               | Shop             | Recommended   | Apple       | Tariff      | iPad Pro 10.5 inch | iPad Pro 10.5 inch 64GB Silver (Active) | GETCFUTariffCTA |
