Feature: 11_Validating_And_Applying_Data_Sort_Order_For_CFU_Tariffs

  11_Validating_And_Applying_Data_Sort_Order_For_CFU_Tariffs

  @Web
  Scenario Outline:11_Validating_And_Applying_Data_Sort_Order_For_CFU_Tariffs
    ...
    Examples:
      ...
      | DuraiArasi | DuraiArasi | Shop         | Apple       | Tariff      | iPad Pro 10.5 inch | iPad Pro 10.5 inch 64GB Silver (Active) | GETCFUTariffCTA | Enable         | data         |
