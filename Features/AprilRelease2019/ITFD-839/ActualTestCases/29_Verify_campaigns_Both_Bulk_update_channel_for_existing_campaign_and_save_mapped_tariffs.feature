Feature: 29_Verify_campaigns_Both_Bulk_update_channel_for_existing_campaign_and_save_mapped_tariffs
  ...
  @Web
  Scenario Outline:29_Verify_campaigns_Both_Bulk_update_channel_for_existing_campaign_and_save_mapped_tariffs
