Feature: 119_FR_All_CFA_Phones_Till_TnE
  ...
  Scenario Outline: 119_FR_All_CFA_Phones_Till_TnE
    ...
    Examples:
      | handset      | tariffAmt | dataValue | color          | Firstname | Surname | consumer | BSCstatus | B1     | B2  | B3  | B4  | Text   | Email | Phone | Post | GDPRstatus | MBBStatus | DeviceType | upFront | term | data | PreSelected | KeyEvent | KeyEvent |
      | Galaxy Note9 | £39       | 8GB       | Midnight Black | Test      | Accepta | Me       | Enabled   | Select | Not | Not | Not | Select | Not   | Not   | Not  | Enabled    | No        | Connected  | max     | max  | max  | No          | No       | No       |
