Feature: 73_Existing_Csutomer_Tablets_Data_filters_options_tariff_and_extras_page
  ...
  Scenario Outline: Existing_Customer_Tablets_Data_filters_options_tariff_and_extras_page
    ...
    Examples:
      ...
      | iPad Pro 10.5 inch | Space Grey | 512GB    | high       | Enabled   | CapMyBill | £60       | Monthly data (High to low) | acce09271344@stf.ref.o2.co.uk | test123  | TEST ACCEPTA | Me       | Not | Not | Select | Not | Not  | Select | Not   | Not  | Enabled    | No        | Connected  | Yes         | No       |
