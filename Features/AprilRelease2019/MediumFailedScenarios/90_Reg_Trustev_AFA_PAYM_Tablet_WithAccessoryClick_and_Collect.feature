Feature: 90_Reg_Trustev_AFA_PAYM_Tablet_WithAccessoryClick_and_Collect
  ...
  Scenario Outline: Trustev PayM Tablets Click and Collect E2E journey with Accessory in Agent shop
    ...
    Examples:
      ...
      | Galaxy S8 Plus 64GB Midnight Black | Refresh | Enabled   | £100          | Samsung S8 Plus Evo Wallet | TEST      | ACCEPTA | 32          | SL11ER   | TEST ACCEPTA | test123  | test123          | Anything        | Not | Not | Select | Not | Not  | Not   | Select | Select | Me       | Enabled | test123  | test123         | Jkhan          | No        | Connected  | Tablet       |
