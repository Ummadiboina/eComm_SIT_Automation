Feature: 47_CFU_Phones_Data_filters_options_tariff_and_extras_page
  ...
  Scenario Outline: Reg_CFU_Phones_Data_filters_options_tariff_and_extras_page
    ...
    Examples:
      ...
      | sittester-3f111af8-a998-474b-9969-23ba2c311a0e@gmail.com | test123  | iPhone X | Enabled   | CapMyBill | £0        | Space Grey | low        | skip   | Monthly data (High to low) | TEST ACCEPTA | Apple | Iphone7 | Orange  | Me       | Select | Not | Not | Not | Not  | Select | Not   | Not  | Enabled    | No        | Connected  | No          | No       |
