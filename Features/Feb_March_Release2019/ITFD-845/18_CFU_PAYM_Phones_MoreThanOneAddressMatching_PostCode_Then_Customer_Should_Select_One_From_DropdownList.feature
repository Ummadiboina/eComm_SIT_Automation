Feature: 18_CFU_PAYM_Phones_MoreThanOneAddressMatching_PostCode_Then_Customer_Should_Select_One_From_DropdownList
  ...
  Scenario Outline: 18_CFU_PAYM_Phones_MoreThanOneAddressMatching_PostCode_Then_Customer_Should_Select_One_From_DropdownList
    ...
    Examples:
      ...
      | till68474417@stf.ref.o2.co.uk | test123  |             | SL11ER   | iPhone X | Enabled   | DontCapMyBill | Nill      | TEST ACCEPTA | enterCode | 129.99upfront37.00amonth | Select | Select | Select | Not | Enabled    | Connected  | No          | No       |
