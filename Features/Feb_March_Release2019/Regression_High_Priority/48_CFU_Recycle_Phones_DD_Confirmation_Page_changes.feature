Feature: 48_CFU_Recycle_Phones_DD_Confirmation_Page_changes
  ...
  then the customer should be able to see the changes in 'Confirmation Page formatting box'
    ...
    Examples:
      ...
      | stester11e6ba32c5-e8be-4e23-977e-2cf86a8969cf@gmail.com | test123  | Enabled   | CapMyBill | £5        | iPhone 7 Plus | 29.99upfront60.34amonth | TEST      | ACCEPTA | TEST ACCEPTA | skip   | Delayed Delivery | Apple | Iphone7 | Orange  | Me       | Not | Select | Not | Not | Select | Not   | Not   | Not  | Enabled    | No        | Connected  | Yes         | No       |
