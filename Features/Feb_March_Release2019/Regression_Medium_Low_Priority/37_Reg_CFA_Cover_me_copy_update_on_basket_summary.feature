Feature: 37_Reg_CFA_Cover_me_copy_update_on_basket_summary
  ...
  download pdf and  verify insurance copy text is displayed on pdf
    ...
    Examples:
      ...
      | iPad Pro 10.5 inch | Space Grey | 32GB     | In Stock | Samsung | Enabled   | CapMyBill | £60       | TEST      | ACCEPTA | TEST ACCEPTA | Me       | Not | Select | Select | Not | Not  | Select | Not   | Not  | Enabled    | No        | Connected  | No          | No       |
