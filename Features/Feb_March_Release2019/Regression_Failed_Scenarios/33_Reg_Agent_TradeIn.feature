Feature: 33_Reg_Agent_TradeIn
  ...
  Scenario Outline: Successful completion of a PAY M dongle Acqusistion Journey
    ...
    Examples:
      ...
      | 07568422122 | iPhone 6s plus 32GB Rose Gold | Refresh | Enabled   | £200          | dont09577112@stf.ref.o2.co.uk | TEST ACCEPTA | HomeDelivery | TEST      | ACCEPTA | TEST ACCEPTA | Flat 6      | SL11EL   | test123  | Me       | Not | Select | Not | Not | Not  | Select | Not   | Not  | Enabled | No        | Connected  | No          |
