Feature: 98_Reg_June_CFU_Validate_BasketPage_For_SimoTariff_With_Active_VoucherablePromotions_Available_And_Valid_For_CurrentDate_And_NoUpfrontPaymentPending
  ...
  Scenario Outline: 98_Reg_June_CFU_Validate_Basket_Page_For_Simo_Tariff_With_Active_Voucherable_Promotions_Available_And_Valid_For_Current_Date_And_No_Upfront_Payment_Pending
    ...
    Examples:
      ...
      | inavl0ww_356240@o2.com | £15       | 6GB       | SIMOOFF   | test123  | Enabled   | DontCapMyBill | Nill      | TEST ACCEPTA | Me       | Not | Select | Not | Not | Not  | Select | Not   | Not  | Enabled    | No        | Connected  | No          | No       |
