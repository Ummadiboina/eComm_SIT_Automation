Feature: 58_Reg_CS_FitnessTrackers
  ...
  Scenario Outline: Fitness Trackers only E2E journey
    ...
    Examples:
      | Device        | Firstname | Surname | Username     | B1     | B2  | B3  | B4  | DeviceType   | PreSelected | KeyEvent | GDPRstatus | KeyEvent |
      | Random Device | TEST      | ACCEPTA | TEST ACCEPTA | Select | Not | Not | Not | NonConnected | No          | No       | Enabled    | No       |
