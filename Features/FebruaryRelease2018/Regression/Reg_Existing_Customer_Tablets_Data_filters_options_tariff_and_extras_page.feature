Feature: Reg_Existing_Customer_Tablets_Data_filters_options_tariff_and_extras_page.feature
  ...
  Scenario Outline: Existing_Customer_Tablets_Data_filters_options_tariff_and_extras_page
   ...
   # And select <capacity> capacity of the connected device
    ...
    Then I should see data filters buttons next to existing sort drop-down for PAYM/SIMO tariffs <sortoption> #Verification point - A - More than 2 should be displayed
    ...
    Examples:
      ...
      | Random Device | Silver | 256GB    | low        | Monthly data (Low to High) | 27fe76531842@stf.ref.o2.co.uk | test123  |
