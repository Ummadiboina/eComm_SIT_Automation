Feature: 49_Reg_CFU_seperate_tariff_ribbons_Tariff_page_Basket_page_html_overlay_for_tariff_ribbons
  ...
  2.Basket page
    ...
    Examples:
      | username                     | password | handset       | tariff                 | color      | BSCstatus | BillCap   | CapAmount |
      | ins_nov1474@stf.ref.o2.co.uk | test123  | iPhone 8 Plus | 9.99upfront84.00amonth | Space Grey | Enabled   | CapMyBill | £10       |
