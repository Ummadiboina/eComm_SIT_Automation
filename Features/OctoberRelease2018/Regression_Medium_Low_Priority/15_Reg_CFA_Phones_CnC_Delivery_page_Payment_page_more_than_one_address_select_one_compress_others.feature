Feature: 15_Reg_CFA_Phones_CnC_Delivery_page_Payment_page_more_than_one_address_select_one_compress_others
  ...
  Scenario Outline:Phones_CnC_Delivery_page_Payment_page_more_than_one_address_select_one_compress_others
    ...
    Examples:
      | handset       | color      | Firstname | Surname | Username     | consumer | BSCstatus | BillCap   | CapAmount | B1     | B2     | B3     | B4  | Text   | Email  | Phone | Post | status  | MBBStatus | DeviceType |
      | iPhone 8 Plus | Space Grey | TEST      | ACCEPTA | TEST ACCEPTA | Me       | Enabled   | CapMyBill | £15       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | No        | Connected  |
