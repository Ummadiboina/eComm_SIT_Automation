Feature: 03_Reg_AFA_Phone_CCN_customer_firstname_apostrophe_and_lastname_apostrophe_SOA_validation_successful
  ...
  Scenario Outline: ConsumerShopToAcceptApostrophe
    ...
    Examples:
      ...
      | iPhone X 256GB Space Grey | Refresh | Base   | Enabled   | £10           | HomeDelivery | test'one  | accepta'two | TEST ACCEPTA | 14          | SL11UP   | Not | Not | Not | Not | Not  | Not   | Not   | Not  | Someone  | Enabled | No        | Connected  | Phone        |
