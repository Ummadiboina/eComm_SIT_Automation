Feature: 68_Reg_CS_Recycle
  ...
  Scenario Outline: This scenario ensures that the customer is able to recycle and upgrade
    ...
    Examples:
      ...
      | 19ju17664673@stf.ref.o2.co.uk | test123  | iPhone 7 | Enabled   | CapMyBill | £10       | 29.99upfront46.00amonth | TEST      | ACCEPTA | TEST ACCEPTA | skip   | Apple | Iphone7 | Orange  | Me       | Not | Select | Not | Not | Select | Not   | Not   | Not  | Enabled | No        | Connected  |
