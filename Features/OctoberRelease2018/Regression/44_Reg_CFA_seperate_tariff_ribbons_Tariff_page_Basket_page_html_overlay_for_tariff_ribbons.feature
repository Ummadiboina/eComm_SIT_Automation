Feature: 44_Reg_CFA_seperate_tariff_ribbons_Tariff_page_Basket_page_html_overlay_for_tariff_ribbons
  ...
  2.Basket page
    ...
    Examples:
      | handset            | color | tariff                  | BSCstatus | BillCap   | CapAmount | Firstname | Surname | Username     | consumer | B1     | B2     | B3  | B4  | Text   | Email | Phone | Post | status  | MBBStatus | DeviceType |
      | Xperia XZ2 Compact | Black | 19.99upfront31.00amonth | Enabled   | CapMyBill | £5        | TEST      | ACCEPTA | TEST ACCEPTA | Me       | Select | Select | Not | Not | Select | Not   | Not   | Not  | Enabled | No        | Connected  |