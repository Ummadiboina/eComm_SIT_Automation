Feature: 131_FR_UpFront_AFA_PAYM_Phones_Acquistion
  ...
  Scenario Outline: Successful completion of a PAY M Acquistion journey
    ...
    Examples:
      ...
      | iPhone 7 Plus 128GB Black | Refresh | min     | avg  | min  | HomeDelivery | Enabled   | £30           | TEST      | ACCEPTA | TEST ACCEPTA | 14          | SL11UP   | test1234 | test1234        | vinudeep       | Me       | Select | Select | Select | Not | Select | Select | Not   | Not  | Enabled | No        | Connected  | Phone        |
