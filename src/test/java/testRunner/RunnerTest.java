...
@CucumberOptions(plugin = {"html:testResult/cucumber-html-report",
        ...
        features = {"Features//MayRelease2019//ITFD-895//OfCom_Actual_Test_Scenarios//OfCom_Enabled//61_CFA_FitnessTracker_Validate_OFCOM_PortIn_Section_When_OfCom_Enabled.feature"},
        glue = {"steps"},
        tags = {"@Web"})
