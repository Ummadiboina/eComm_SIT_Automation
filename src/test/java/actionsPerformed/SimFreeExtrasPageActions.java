...
public class SimFreeExtrasPageActions extends Environment {
		...
		{  System.out.println(" ");
			...
			if(pageobjects.SimFreeExtrasPage.PayMTab.getText().contains("Pay Monthly"))
			 {
				System.out.println("The Paym_Tab is Present and the Text is :" + pageobjects.SimFreeExtrasPage.PayMTab.getText() );
			 }else{
			  System.out.println("The  Paym_Tab is Absent and the Text is :" + pageobjects.SimFreeExtrasPage.PayMTab.getText());
			 }
		
			if(pageobjects.SimFreeExtrasPage.PayGTab.getText().contains("Pay As You Go"))
			 {
				System.out.println("The PayG_Tab is Present and the Text is :" +pageobjects.SimFreeExtrasPage.PayGTab.getText() );
			 }else{
			  System.out.println("The  PayG_Tab is Absent and the Text is :" +pageobjects.SimFreeExtrasPage.PayGTab.getText());
			 }
			/*if(pageobjects.ExtrasPage.GotoBasket.getText().contains("Go to basket"))
			 {
				System.out.println("The GoToBasket_Tab is Present and the Text is :" +pageobjects.ExtrasPage.GotoBasket.getText());
			 }else{
			  System.out.println("The  GoToBasket_Tab is Absent and the Text is :" +pageobjects.ExtrasPage.GotoBasket.getText());
			  
			 }*/
			if(pageobjects.SimFreeExtrasPage.Contractlength.getText().contains("Contract length"))
			 {
				System.out.println("The Contractlength_label is Present and the Text is :" +pageobjects.SimFreeExtrasPage.Contractlength.getText());
			 }else{
			  System.out.println("The  Contractlength_label is Absent and the Text is :" +pageobjects.SimFreeExtrasPage.Contractlength.getText());
			  
			 }
			if(pageobjects.SimFreeExtrasPage.months12tab.getText().contains("12 months"))
			 {
				System.out.println("The 12 months_Tab is Present and the Text is :" +pageobjects.SimFreeExtrasPage.months12tab.getText());
			 }else{
			  System.out.println("The  12 months_Tab is Absent and the Text is :" +pageobjects.SimFreeExtrasPage.months12tab.getText());
			  
			 }
			
			if(pageobjects.SimFreeExtrasPage.days30tab.getText().contains("30 days"))
			 {
				System.out.println("The 30 days_Tab is Present and the Text is :" +pageobjects.SimFreeExtrasPage.days30tab.getText());
			 }else{
			  System.out.println("The  30 days_Tab is Absent and the Text is :" +pageobjects.SimFreeExtrasPage.days30tab.getText());
		...
		public static void tariffvalidation(String ElementName) 
		{
			if(ElementName.equalsIgnoreCase(pageobjects.SimFreeExtrasPage.Tariffvaladity.getText()))
			{
				...
				System.out.println("The Tariff detail is Present and the Text is :" +pageobjects.SimFreeExtrasPage.Tariffvaladity.getText());
			 }
			else
			{
