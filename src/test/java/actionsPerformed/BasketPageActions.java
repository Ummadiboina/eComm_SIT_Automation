...
public class BasketPageActions extends Environment {
    ...
    public static String devicecolorcapacity = "";
...
*/
    ...
    public static void DeviceandTariffdetail_Accessories() throws InterruptedException, IOException {
        if(driver.findElements(By.xpath("//section[@class='product-details']/h3/span")).size()>0) {
            devicename = driver.findElement(By.xpath("//section[@class='product-details']/h3/span")).getText();
            devicecolorcapacity = driver.findElement(By.xpath("(//section[@class='product-details']/p[@class='capacity-colour'])[1]")).getText();
        }
        if(driver.findElements(By.xpath("(//section[@data-qa-type='tariff']//p)[1]")).size()>0) {
            tariff = driver.findElement(By.xpath("(//section[@data-qa-type='tariff']//p)[1]")).getText();
        }
        if (driver.findElements(By.xpath("//h3[@class='ac-qauantity-heading']//span")).size()>0)
        {
            accessories=driver.findElement(By.xpath("//h3[@class='ac-qauantity-heading']//span")).getText();
        }
