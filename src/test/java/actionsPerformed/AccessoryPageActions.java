...
// This Method is used to select Accessory from the accessory listing page
    ...
    public static void SelectAnyAccessory(String elementName) throws IOException, InterruptedException, AWTException {
    ...
    public static void selectAnyAccessoryLimit() throws IOException {
        ...
        try {
            ...
            if (status.contains("In Stock")) {
                //driver.findElement(By.xpath("//label[normalize-space(.)=':']/parent::div//span[@role='combobox']/span/span[1]")).click();
