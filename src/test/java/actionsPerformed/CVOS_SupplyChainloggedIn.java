...
public class CVOS_SupplyChainloggedIn extends Environment {
	...
	public static void CVOSSupplyChainVal() throws InterruptedException {
		...
		if (pageobjects.CVOS_PageObjects.templateTab.isDisplayed()) {
			System.out.println(
					"The template tab is displayed : " + pageobjects.CVOS_PageObjects.templateTab.getText());
		...
		if (pageobjects.CVOS_PageObjects.stockUploadTab.isDisplayed()) {
			System.out.println("The Stock Upload tab is displayed : "
					+ pageobjects.CVOS_PageObjects.stockUploadTab.getText());
			log.debug("The Stock Upload tab is displayed : "
					+ pageobjects.CVOS_PageObjects.stockUploadTab.getText());
		} else
		...
		if (pageobjects.CVOS_PageObjects.skuMasterTab.isDisplayed()) {
			System.out.println("The skuMasterTab is displayed : "
					+ pageobjects.CVOS_PageObjects.skuMasterTab.getText());
			log.debug("The skuMasterTab is displayed : "
					+ pageobjects.CVOS_PageObjects.skuMasterTab.getText());
		} else
