Feature: CFU Refresh Order Delayed delivery phone with InStock Accessory Basket Review and Confirmation Page 
...
Scenario Outline: 
	...
	Examples: 
		...
		| GalaxyS7 | TEST ACCEPTA | ini_aug5200 | test123 | pink |
