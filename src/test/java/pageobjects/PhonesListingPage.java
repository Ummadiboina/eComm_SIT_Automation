...
public class PhonesListingPage {
	...
	@FindBy(how = How.XPATH, using = "(//img[@class='device-image'])[1] | (//img[@class='device-image lazyload'])[1]")
	...
	@FindBy(how = How.XPATH, using = ("//input[@name='search' or @id='listing-search']"))
