...
public class SIMFree {
	...
	public void I_add_Sim_free_device_along_with_the_Airtime_plan(String arg1) throws Throwable {
		 ...
		 WebElement w1=Environment.driver.findElement(By.xpath("(//*[@id='PayMonthlyTariffsGridTab']/li[1]/div/h3)[1]"));
		...
		{
			Environment.driver.findElement(By.xpath("(//a[contains(text(),'Pay As You Go')])[9]")).sendKeys(Keys.ENTER);
			Thread.sleep(10000);		
			Environment.driver.findElement(By.xpath("(//*[@id='callToAction'])[15]")).sendKeys(Keys.ENTER);
		}
		else
		{
		Environment.driver.findElement(By.xpath("(//button[@value='Select'])[3]")).sendKeys(Keys.ENTER);
