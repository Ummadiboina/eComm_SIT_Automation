Feature: CFA PayM phones Additional information and Order Declined

  @smokeTest
  Scenario: CFA PayM phones Additional information and Order Declined
    ...
    And input Firstname as "TEST" and surname as "DECLINEA" in Delivery page
